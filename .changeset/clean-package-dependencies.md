...
Declare all dependencies required by published JavaScript and types, include theme declarations, and keep shadow root option types compatible with consumer Lit versions.
