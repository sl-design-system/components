...
- Update `tool-bar.ts` to use the new measurement utilities (`setItemVisibility`, `measureMenuButtonWidth` and `measureConstrainedWidth`) for more reliable overflow calculations,
