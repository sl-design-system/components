...
- [`callout`](https://github.com/sl-design-system/components/blob/main/packages/components/callout/CHANGELOG.md) has improved color contrast when using links in the body. The `variants` values have changed to match other components.
