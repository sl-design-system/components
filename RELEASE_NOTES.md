...
- [`panel`](https://github.com/sl-design-system/components/blob/main/packages/components/panel/CHANGELOG.md) fixes `no-header` attribute not being set correctly when header is empty.
