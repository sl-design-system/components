...
import { All as AllSelectDay } from '../../../packages/components/calendar/src/select-day.stories';
import { All as AllSelectMonth } from '../../../packages/components/calendar/src/select-month.stories';
import { All as AllSelectYear } from '../../../packages/components/calendar/src/select-year.stories';
...
export const SelectDay = { render: AllSelectDay.render };
export const SelectMonth = { render: AllSelectMonth.render };
export const SelectYear = { render: AllSelectYear.render };
