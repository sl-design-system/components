...
export default {
  ...
  parameters: {
    chromatic: {
      modes: {
        bingelDc: allModes['bingelDc'],
        bingelInt: allModes['bingelInt'],
        clickedu: allModes['clickedu'],
        editorialSuite: allModes['editorialSuite'],
        itslearning: allModes['itslearning'],
        kampus: allModes['kampus'],
        magister: allModes['magister'],
        max: allModes['max'],
        myDigitalBook: allModes['myDigitalBook'],
        myvanin: allModes['myvanin'],
        neon: allModes['neon'],
        nowaEra: allModes['nowaEra'],
        'sanoma-learning': allModes['sanoma-learning'],
        sanomaUtbildning: allModes['sanomaUtbildning'],
        teas: allModes['teas'],
      },
    },
  },
