...
const tsEntrypoints = [
  ...
  './src/site/ts/components/alert/alert.ts',
  // '@sanomalearning/slds-core/button/register.js',
  //'@sanomalearning/slds-core/button',
  //'packages/core/dist/components/button/button.js',
  // n'@sanomalearning/storybook-addon-themes/theme.js',
