...
@Component({
  ...
  template: `
    <div class="example-input">
      ...
      <sl-text-field id="text-field" [value]="value" (sl-input)="onValueChange($event.target)" required></sl-text-field>
      <div>
        value: <i>{{ value }}</i>
      </div>
    </div>
...
//       <sl-textarea
//         id="textarea-onchange"
//         name="textarea"
//         placeholder="Placeholder"
//         [value]="textarea1"
//         (input)="onTextareaValueChange($event.target)"
//       ></sl-textarea>
//       <div>
//         value: <i>{{ textarea1 }}</i>
//       </div>
...
//   onTextareaValueChange(element: HTMLTextAreaElement): void {
//     this.textarea1 = element.value;
//   }
// }
...
//       <sl-label for="textarea-onchange">My label</sl-label>
//       <sl-checkbox id="checkbox-onchange-id" [value]="checkboxValue" (sl-change)="onCheckboxValueChange($event.target)"
...
//   onCheckboxValueChange(element: Checkbox): void {
...
//         hint="This is a hint for the text field with your name"
//         minlength="8"
//         required
//       >
//       </sl-text-field>
...
//         hint="Your website adress (should contain 'https' and 'com' parts)"
//         minlength="8"
//         required
//       >
//       </sl-text-field>
...
//         id="description-id"
//         #myReactiveTextarea
//         (input)="onInput(this.myForm.controls.description)"
//         formControlName="description"
//         placeholder="Add short description here"
//         hint="This textarea should contain a short description starting with 'This is'"
//         required
//       >
...
//         otherErrors = this.myForm.controls.description.errors
//           ? Object.keys(this.myForm.controls.description.errors).length
//           : 0;
...
//     this.myCheckbox.nativeElement.reportValidity();
//     this.myRadioGroup.nativeElement.reportValidity();
...
// function validateUrl(control: AbstractControl<string>): ValidationErrors | null {
...
// function startsWithThisIs(control: AbstractControl<string>): ValidationErrors | null {
...
//     this.myInput.reportValidity();
//     this.myTextarea.reportValidity();
//     this.myCheckbox.nativeElement.reportValidity();
//     this.myRadioGroup.nativeElement.reportValidity();
//   }
// }
...
//       <sl-text-field
//         id="my-value"
//         hint="This is a hint for text field"
//         placeholder="Type at least 8 characters"
//         [(ngModel)]="model.name"
//         (input)="onInput(inputWithNgmodel)"
//         #inputWithNgmodel="ngModel"
//         name="name"
//         minlength="8"
//         required
//       >
...
//       <sl-textarea
//         id="textarea-ngmodel-id"
//         placeholder="Type at least 8 characters"
//         [(ngModel)]="model.description"
//         #textareaWithNgmodel="ngModel"
//         (input)="onInput(textareaWithNgmodel)"
//         name="description"
//         hint="This is a hint for textarea"
//         minlength="8"
//         required
//       ></sl-textarea>
//       <sl-label for="checkboxWithNgmodel">Checkbox</sl-label>
//       <sl-checkbox
//         id="checkboxWithNgmodel"
//         #checkboxWithNgmodel="ngModel"
//         [(ngModel)]="model.approval"
//         name="approval"
//         hint="This is a hint for checkbox"
//         required
//         >my checkbox</sl-checkbox
//       >
//       <sl-label for="radio-group">Select option</sl-label>
//       <sl-radio-group
//         id="radio-group"
//         #radioGroupWithNgmodel="ngModel"
//         [(ngModel)]="model.option"
//         name="option"
//         hint="This is a hint for radio group"
//         required
//       >
...
//       </div>
//       <div>
//         Description: <i>{{ model.description }}</i>
//       </div>
//       <div>
//         Approval: <i>{{ model.approval }}</i>
//       </div>
//       <div>
//         Option: <i>{{ model.option }}</i>
//       </div>
//     </form>
//   `
// })
...
//       <sl-textarea
//         id="textarea-ngmodel-id"
//         hint="This is a hint for the description"
