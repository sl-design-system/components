...
export default css`
  ...
  :host {
    ...
    --sl-color-palette-warning-500: #cc7700; /* color.palette.warning.500 */
    ...
    --sl-text-typeset-paragraph-spacing-none: 0rem; /* text.typeset.paragraphSpacing.none */
    ...
    --sl-border-width-none: 0rem; /* border.width.none */
    ...
    --sl-border-radius-none: 0rem; /* border.radius.none */
    ...
    --sl-text-href-disabled-lg: var(--sl-text-typeset-font-weight-bold) var(--sl-text-typeset-font-size-lg) / 24px
      var(--sl-text-typeset-font-family-body);
    --sl-text-href-disabled-md: var(--sl-text-typeset-font-weight-bold) var(--sl-text-typeset-font-size-md) / 16px
      var(--sl-text-typeset-font-family-body);
    --sl-text-href-disabled-sm: var(--sl-text-typeset-font-weight-bold) var(--sl-text-typeset-font-size-sm) / 16px
      var(--sl-text-typeset-font-family-body);
    --sl-text-href-active-lg: var(--sl-text-typeset-font-weight-bold) var(--sl-text-typeset-font-size-lg) / 24px
      var(--sl-text-typeset-font-family-body);
    --sl-text-href-active-md: var(--sl-text-typeset-font-weight-bold) var(--sl-text-typeset-font-size-md) / 16px
      var(--sl-text-typeset-font-family-body);
    --sl-text-href-active-sm: var(--sl-text-typeset-font-weight-bold) var(--sl-text-typeset-font-size-sm) / 16px
      var(--sl-text-typeset-font-family-body);
    --sl-text-href-hover-lg: var(--sl-text-typeset-font-weight-bold) var(--sl-text-typeset-font-size-lg) / 24px
      var(--sl-text-typeset-font-family-body);
    --sl-text-href-hover-md: var(--sl-text-typeset-font-weight-bold) var(--sl-text-typeset-font-size-md) / 16px
      var(--sl-text-typeset-font-family-body);
    --sl-text-href-hover-sm: var(--sl-text-typeset-font-weight-bold) var(--sl-text-typeset-font-size-sm) / 16px
      var(--sl-text-typeset-font-family-body);
    --sl-text-href-idle-lg: var(--sl-text-typeset-font-weight-bold) var(--sl-text-typeset-font-size-lg) / 24px
      var(--sl-text-typeset-font-family-body);
    --sl-text-href-idle-md: var(--sl-text-typeset-font-weight-bold) var(--sl-text-typeset-font-size-md) / 16px
      var(--sl-text-typeset-font-family-body);
    --sl-text-href-idle-sm: var(--sl-text-typeset-font-weight-bold) var(--sl-text-typeset-font-size-sm) / 16px
      var(--sl-text-typeset-font-family-body);
    ...
    --sl-text-input-field-label-hint-sm: var(--sl-text-typeset-font-weight-regular) var(--sl-text-typeset-font-size-md) /
      var(--sl-text-typeset-line-height-md) var(--sl-text-typeset-font-family-body); /* UPDATED - Line height md from 22px to 20px */
    --sl-text-input-field-label-label-lg: var(--sl-text-typeset-font-weight-demibold) var(--sl-text-typeset-font-size-lg) /
    ...
    --sl-text-input-field-label-label-md: var(--sl-text-typeset-font-weight-demibold) var(--sl-text-typeset-font-size-md) /
      var(--sl-text-typeset-line-height-md) var(--sl-text-typeset-font-family-body); /* UPDATED - Line height md from 22px to 20px */
    --sl-text-input-field-label-label-sm: var(--sl-text-typeset-font-weight-demibold) var(--sl-text-typeset-font-size-md) /
      var(--sl-text-typeset-line-height-md) var(--sl-text-typeset-font-family-body); /* UPDATED - Line height md from 22px to 20px */
    ...
    --sl-text-dialog-message-mobile-heading: var(--sl-text-typeset-font-weight-bold) var(--sl-icon-typeset-font-size-md) /
      var(--sl-text-typeset-line-height-md) var(--sl-text-typeset-font-family-heading);
    ...
    --sl-border-radius-focusring-inside: calc(var(--sl-border-radius-default) - 1);
    ...
    --sl-text-avatar-icon-sm: var(--sl-icon-style-outline) var(--sl-text-typeset-font-size-md)
      var(--sl-text-typeset-font-family-icon);
    --sl-space-focus-gap: var(--sl-border-width-focusring-default) + var(--sl-border-width-focusring-offset);
  ...
  @media (prefers-color-scheme: light) {
    :host {
      --sl-color-field-button-default-active-background: rgba(
        34,
        34,
        34,
        0.13
      ); /* color.button.default.active.background */
      --sl-color-field-button-default-hover-background: rgba(
        34,
        34,
        34,
        0.07
  ...
  @media (prefers-color-scheme: dark) {
    :host {
      ...
      --sl-color-button-default-outline-selected-active-foreground: var(
        --sl-color-palette-neutral-50
      ); /* color.button.primary.outline.active.foreground */
      --sl-color-button-default-outline-selected-active-background: var(
        --sl-color-palette-primary-800
      ); /* color.button.default.outline.active.background */
      --sl-color-button-default-outline-selected-hover-border: var(
        --sl-color-palette-neutral-50
      ); /* color.button.default.outline.hover.border */
