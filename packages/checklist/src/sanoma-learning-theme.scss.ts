...
export default css`
  /**
   * Copyright 2024 Sanoma Learning
   ...
   */
  :host {
    --sl-color-palette-transparent-base: #00000000; /* color.palette.transparent.base */
    --sl-color-palette-white-base: #fefefe; /* color.palette.white.base */
    --sl-color-palette-black-base: #222222; /* color.palette.black.base */
    ...
    --sl-color-palette-warning-base: #ffcf0d; /* color.palette.warning.base */
    --sl-color-palette-warning-900: #261d0b; /* color.palette.warning.900 */
    --sl-color-palette-warning-800: #34270c; /* color.palette.warning.800 */
    --sl-color-palette-warning-700: #563d0c; /* color.palette.warning.700 */
    --sl-color-palette-warning-600: #79590d; /* color.palette.warning.600 */
    --sl-color-palette-warning-500: #ae830e; /* color.palette.warning.500 */
    --sl-color-palette-warning-400: #e1b00f; /* color.palette.warning.400 */
    --sl-color-palette-warning-200: #feda42; /* color.palette.warning.200 */
    --sl-color-palette-warning-150: #fde376; /* color.palette.warning.150 */
    --sl-color-palette-warning-100: #fcecaa; /* color.palette.warning.100 */
    --sl-color-palette-warning-50: #faf4dc; /* color.palette.warning.50 */
    ...
    --sl-color-palette-info-base: #3366ff; /* color.palette.info.base */
    ...
    --sl-color-palette-neutral-base: #222222; /* color.palette.neutral.base */
    ...
    --sl-color-palette-accent-base: #3366ff; /* color.palette.accent.base */
    ...
    --sl-color-palette-primary-base: #222222; /* color.palette.primary.base */
    ...
    --sl-icon-core-house: house; /* icon.core.house */
    ...
    --sl-text-typeset-paragraph-spacing-none: 0px; /* text.typeset.paragraphSpacing.none */
    ...
    --sl-text-typeset-font-weight-demibold: 600; /* text.typeset.fontWeight.demibold */
    ...
    --sl-text-typeset-font-family-body: 'source-sans-pro'; /* text.typeset.fontFamily.body */
    --sl-text-typeset-font-family-heading: 'the-message'; /* text.typeset.fontFamily.heading */
    --sl-space-badge-label-inline-3xl: 3px;
    --sl-space-badge-label-inline-2xl: 3px;
    --sl-space-badge-label-inline-xl: 3px;
    --sl-space-badge-icon-block-2xl: 1px;
    --sl-space-badge-icon-inline-2xl: 1px;
    --sl-space-badge-gap-md: 3px;
    --sl-space-badge-inline-3xl: 3px;
    --sl-space-badge-inline-md: 1px;
    ...
    --sl-border-radius-none: 0px; /* border.radius.none */
    ...
    --sl-component-button-md-width: var(--sl-size-sm);
    --sl-component-button-md-height: var(--sl-size-sm);
    --sl-component-button-lg-width: var(--sl-size-md);
    --sl-component-button-lg-height: var(--sl-size-md);
    ...
    --sl-color-palette-warning-300: var(--sl-color-palette-warning-base); /* color.palette.warning.300 */
    ...
    --sl-box-shadow-slds-checklist: 0 0 4px 0 rgba(34, 34, 34, var(--sl-opacity-50)),
      0 4px 8px 0 rgba(34, 34, 34, var(--sl-opacity-150));
    --sl-elevation-shadow-none: var(--sl-opacity-transparent) 0 0 0 rgba(34, 34, 34, 0);
    --sl-elevation-shadow-lg: 0 0 4px 0 rgba(34, 34, 34, var(--sl-opacity-100)),
      0 8px 16px 0 rgba(34, 34, 34, var(--sl-opacity-200));
    --sl-elevation-shadow-md: 0 0 4px 0 rgba(34, 34, 34, var(--sl-opacity-50)),
      0 4px 8px 0 rgba(34, 34, 34, var(--sl-opacity-150));
    --sl-elevation-shadow-sm: 0 0 6px 0 rgba(34, 34, 34, var(--sl-opacity-50)),
      0 2px 4px 0 rgba(34, 34, 34, var(--sl-opacity-200));
    ...
    --sl-text-card-body: var(--sl-text-typeset-font-weight-regular) var(--sl-text-typeset-font-size-md) /
      var(--sl-text-typeset-line-height-md) var(--sl-text-typeset-font-family-body);
    --sl-text-card-subtitle: var(--sl-text-typeset-font-weight-regular) var(--sl-text-typeset-font-size-lg) /
      var(--sl-text-typeset-line-height-lg) var(--sl-text-typeset-font-family-body);
    --sl-text-card-title: var(--sl-text-typeset-font-weight-regular) var(--sl-text-typeset-font-size-xl) /
      var(--sl-text-typeset-line-height-xl) var(--sl-text-typeset-font-family-heading);
    --sl-text-popover-text-title: var(--sl-text-typeset-font-weight-bold) var(--sl-text-typeset-font-size-md) /
      var(--sl-text-typeset-line-height-md) var(--sl-text-typeset-font-family-body);
    --sl-text-popover-text-text: var(--sl-text-typeset-font-weight-regular) var(--sl-text-typeset-font-size-md) /
      var(--sl-text-typeset-line-height-md) var(--sl-text-typeset-font-family-body);
    --sl-text-select-selectbox-title-lg: var(--sl-text-typeset-font-weight-regular) var(--sl-text-typeset-line-height-xs) /
      var(--sl-icon-typeset-font-size-sm) var(--sl-text-typeset-font-family-body);
    --sl-text-select-selectbox-title-md: var(--sl-text-typeset-font-weight-regular) var(--sl-text-typeset-line-height-xxs) /
      var(--sl-icon-typeset-font-size-xs) var(--sl-text-typeset-font-family-body);
    ...
    --sl-text-input-switch-input-field-bold-lg: var(--sl-text-typeset-font-weight-bold)
    ...
    --sl-text-input-switch-input-field-bold-md: var(--sl-text-typeset-font-weight-bold)
    ...
    --sl-text-input-switch-input-field-bold-sm: var(--sl-text-typeset-font-weight-bold)
    ...
    --sl-text-input-switch-input-field-regular-sm: var(--sl-text-typeset-font-weight-regular)
      var(--sl-text-typeset-font-size-md) / var(--sl-text-typeset-line-height-sm) var(--sl-text-typeset-font-family-body); /* UPDATED - Line height md from 22px to 20px */
    --sl-text-input-helper-text-lg: var(--sl-text-typeset-font-weight-regular) var(--sl-text-typeset-font-size-lg) /
      var(--sl-text-typeset-line-height-lg) var(--sl-text-typeset-font-family-body);
    --sl-text-input-helper-text-md: var(--sl-text-typeset-font-weight-regular) var(--sl-text-typeset-font-size-md) /
      var(--sl-text-typeset-line-height-md) var(--sl-text-typeset-font-family-body); /* UPDATED - Line height md from 22px to 20px */
    --sl-text-input-helper-text-sm: var(--sl-text-typeset-font-weight-regular) var(--sl-text-typeset-font-size-sm) /
      var(--sl-text-typeset-line-height-sm) var(--sl-text-typeset-font-family-body); /* UPDATED - Line height md from 22px to 20px */
    --sl-text-input-field-label-tag-lg: var(--sl-text-typeset-font-weight-regular) var(--sl-text-typeset-font-size-xl) /
      var(--sl-text-typeset-line-height-lg) var(--sl-text-typeset-font-family-body); /* Font size xl is 18px need to be change to 20px to match 4-Grid layout. */
    --sl-text-input-field-label-tag-md: var(--sl-text-typeset-font-weight-regular) var(--sl-text-typeset-font-size-lg) /
      var(--sl-text-typeset-line-height-lg) var(--sl-text-typeset-font-family-body); /* UPDATED - Line height md from 22px to 20px */
    --sl-text-input-field-label-tag-sm: var(--sl-text-typeset-font-weight-regular) var(--sl-text-typeset-font-size-md) /
      var(--sl-text-typeset-line-height-sm) var(--sl-text-typeset-font-family-body); /* UPDATED - Line height md from 22px to 20px */
    --sl-text-input-field-label-label-lg: var(--sl-text-typeset-font-weight-bold) var(--sl-text-typeset-font-size-xl) /
      var(--sl-text-typeset-line-height-lg) var(--sl-text-typeset-font-family-body); /* Font size xl is 18px need to be change to 20px to match 4-Grid layout. */
    --sl-text-input-field-label-label-md: var(--sl-text-typeset-font-weight-bold) var(--sl-text-typeset-font-size-lg) /
      var(--sl-text-typeset-line-height-lg) var(--sl-text-typeset-font-family-body); /* UPDATED - Line height md from 22px to 20px */
    --sl-text-input-field-label-label-sm: var(--sl-text-typeset-font-weight-bold) var(--sl-text-typeset-font-size-md) /
      var(--sl-text-typeset-line-height-sm) var(--sl-text-typeset-font-family-body); /* UPDATED - Line height md from 22px to 20px */
    ...
    --sl-text-tooltip-text-tip: var(--sl-text-typeset-font-weight-regular) var(--sl-text-typeset-font-size-sm) /
      var(--sl-button-label-md) var(--sl-text-typeset-font-family-body);
    --sl-text-button-link-disabled-lg: var(--sl-text-typeset-font-weight-bold) var(--sl-text-typeset-font-size-lg) /
      var(--sl-button-label-lg) var(--sl-text-typeset-font-family-body);
    --sl-text-button-link-disabled-md: var(--sl-text-typeset-font-weight-bold) var(--sl-text-typeset-font-size-md) /
      var(--sl-button-label-md) var(--sl-text-typeset-font-family-body);
    --sl-text-button-link-disabled-sm: var(--sl-text-typeset-font-weight-bold) var(--sl-text-typeset-font-size-sm) /
      var(--sl-button-label-sm) var(--sl-text-typeset-font-family-body);
    --sl-text-button-link-active-lg: var(--sl-text-typeset-font-weight-bold) var(--sl-text-typeset-font-size-lg) /
      var(--sl-button-label-lg) var(--sl-text-typeset-font-family-body);
    --sl-text-button-link-active-md: var(--sl-text-typeset-font-weight-bold) var(--sl-text-typeset-font-size-md) /
      var(--sl-button-label-md) var(--sl-text-typeset-font-family-body);
    --sl-text-button-link-active-sm: var(--sl-text-typeset-font-weight-bold) var(--sl-text-typeset-font-size-sm) /
      var(--sl-button-label-sm) var(--sl-text-typeset-font-family-body);
    --sl-text-button-link-hover-lg: var(--sl-text-typeset-font-weight-bold) var(--sl-text-typeset-font-size-lg) /
      var(--sl-button-label-lg) var(--sl-text-typeset-font-family-body);
    --sl-text-button-link-hover-md: var(--sl-text-typeset-font-weight-bold) var(--sl-text-typeset-font-size-md) /
      var(--sl-button-label-md) var(--sl-text-typeset-font-family-body);
    --sl-text-button-link-hover-sm: var(--sl-text-typeset-font-weight-bold) var(--sl-text-typeset-font-size-sm) /
      var(--sl-button-label-sm) var(--sl-text-typeset-font-family-body);
    --sl-text-button-link-idle-lg: var(--sl-text-typeset-font-weight-bold) var(--sl-text-typeset-font-size-lg) /
      var(--sl-button-label-lg) var(--sl-text-typeset-font-family-body);
    --sl-text-button-link-idle-md: var(--sl-text-typeset-font-weight-bold) var(--sl-text-typeset-font-size-md) /
      var(--sl-button-label-md) var(--sl-text-typeset-font-family-body);
    --sl-text-button-link-idle-sm: var(--sl-text-typeset-font-weight-bold) var(--sl-text-typeset-font-size-sm) /
      var(--sl-button-label-sm) var(--sl-text-typeset-font-family-body);
    --sl-text-button-link-lg: var(--sl-text-typeset-font-weight-regular) var(--sl-text-typeset-font-size-lg) /
      var(--sl-button-label-lg) var(--sl-text-typeset-font-family-body);
    --sl-text-button-link-md: var(--sl-text-typeset-font-weight-regular) var(--sl-text-typeset-font-size-md) /
      var(--sl-button-label-md) var(--sl-text-typeset-font-family-body);
    --sl-text-button-link-sm: var(--sl-text-typeset-font-weight-regular) var(--sl-text-typeset-font-size-sm) /
      var(--sl-button-label-sm) var(--sl-text-typeset-font-family-body);
    --sl-text-button-font-icon-lg: 400 var(--sl-text-typeset-line-height-sm) / var(--sl-text-typeset-font-size-lg)
      sans-serif;
    --sl-text-button-font-icon-md: 400 var(--sl-text-typeset-line-height-xs) / var(--sl-text-typeset-font-size-md)
      sans-serif;
    --sl-text-button-font-icon-sm: 400 13px / var(--sl-text-typeset-line-height-xxs) sans-serif;
    --sl-text-button-text-lg: var(--sl-text-typeset-font-weight-regular) var(--sl-text-typeset-font-size-lg) /
      var(--sl-button-label-lg) var(--sl-text-typeset-font-family-body);
    --sl-text-button-text-md: var(--sl-text-typeset-font-weight-regular) var(--sl-text-typeset-font-size-md) /
      var(--sl-button-label-md) var(--sl-text-typeset-font-family-body);
    --sl-text-button-text-sm: var(--sl-text-typeset-font-weight-regular) var(--sl-text-typeset-font-size-sm) /
      var(--sl-button-label-sm) var(--sl-text-typeset-font-family-body);
    ...
    --sl-text-tab-title: var(--sl-text-typeset-font-weight-demibold) var(--sl-text-typeset-font-size-lg) /
      var(--sl-text-typeset-line-height-md) var(--sl-text-typeset-font-family-body);
    --sl-text-body-lg-bold: var(--sl-text-typeset-font-weight-bold) var(--sl-text-typeset-font-size-lg) /
    ...
    --sl-text-body-md-bold: var(--sl-text-typeset-font-weight-bold) var(--sl-text-typeset-font-size-md) /
    ...
    --sl-text-body-sm-bold: var(--sl-text-typeset-font-weight-bold) var(--sl-text-typeset-font-size-sm) /
    ...
    --sl-text-heading-4: var(--sl-text-typeset-font-weight-bold) var(--sl-text-typeset-font-size-lg) /
    ...
    --sl-text-heading-2: var(--sl-text-typeset-font-weight-bold) var(--sl-text-typeset-font-size-2xl) /
    ...
    --sl-text-heading-0: var(--sl-text-typeset-font-weight-bold) var(--sl-text-typeset-font-size-4xl) /
      var(--sl-text-typeset-line-height-4xl) var(--sl-text-typeset-font-family-heading); /* text.typeset.heading.0 */
    --sl-text-badge-text-3xl: var(--sl-text-typeset-font-weight-demibold) var(--sl-text-typeset-font-size-sm) /
      var(--sl-text-typeset-line-height-sm) var(--sl-text-typeset-font-family-body);
    --sl-text-badge-text-2xl: var(--sl-text-typeset-font-weight-demibold) var(--sl-text-typeset-font-size-xs) /
      var(--sl-text-typeset-line-height-xxs) var(--sl-text-typeset-font-family-body);
    --sl-text-badge-text-xl: var(--sl-text-typeset-font-weight-demibold) var(--sl-text-typeset-font-size-xs) /
      var(--sl-text-typeset-line-height-xxs) var(--sl-text-typeset-font-family-body);
    --sl-text-badge-text-lg: var(--sl-text-typeset-font-weight-demibold) var(--sl-text-typeset-font-size-xs) /
      var(--sl-text-typeset-line-height-xs) var(--sl-text-typeset-font-family-body);
    --sl-text-badge-text-md: var(--sl-text-typeset-font-weight-demibold) 9px/9px var(--sl-text-typeset-font-family-body);
    --sl-text-badge-text-sm: var(--sl-text-typeset-font-weight-demibold) 6px/6px var(--sl-text-typeset-font-family-body);
    --sl-text-avatar-subheader-3xl: var(--sl-text-typeset-font-weight-regular) var(--sl-text-typeset-font-size-sm) /
      var(--sl-text-typeset-line-height-xxs) var(--sl-text-typeset-font-family-body);
    --sl-text-avatar-subheader-2xl: var(--sl-text-typeset-font-weight-regular) var(--sl-text-typeset-font-size-sm) /
      var(--sl-text-typeset-line-height-xxs) var(--sl-text-typeset-font-family-body);
    --sl-text-avatar-subheader-xl: var(--sl-text-typeset-font-weight-regular) var(--sl-text-typeset-font-size-sm) /
      var(--sl-text-typeset-line-height-xxs) var(--sl-text-typeset-font-family-body);
    --sl-text-avatar-subheader-lg: var(--sl-text-typeset-font-weight-regular) var(--sl-text-typeset-font-size-sm) /
      var(--sl-text-typeset-line-height-xxs) var(--sl-text-typeset-font-family-body);
    --sl-text-avatar-subheader-md: var(--sl-text-typeset-font-weight-regular) var(--sl-text-typeset-font-size-sm) /
      var(--sl-text-typeset-line-height-xxs) var(--sl-text-typeset-font-family-body);
    ...
    --sl-text-avatar-header-2xl: var(--sl-text-typeset-font-weight-regular) var(--sl-text-typeset-font-size-lg) /
      var(--sl-text-typeset-line-height-md) var(--sl-text-typeset-font-family-body);
    --sl-text-avatar-header-xl: var(--sl-text-typeset-font-weight-regular) var(--sl-text-typeset-font-size-md) /
      var(--sl-text-typeset-line-height-md) var(--sl-text-typeset-font-family-body);
    --sl-text-avatar-header-lg: var(--sl-text-typeset-font-weight-regular) var(--sl-text-typeset-font-size-md) /
      var(--sl-text-typeset-line-height-sm) var(--sl-text-typeset-font-family-body);
    --sl-text-avatar-header-md: var(--sl-text-typeset-font-weight-regular) var(--sl-text-typeset-font-size-md) /
      var(--sl-text-typeset-line-height-sm) var(--sl-text-typeset-font-family-body);
    --sl-text-avatar-header-sm: var(--sl-text-typeset-font-weight-regular) var(--sl-text-typeset-font-size-md) /
      var(--sl-text-typeset-line-height-xs) var(--sl-text-typeset-font-family-body);
    --sl-text-avatar-initials-3xl: var(--sl-text-typeset-font-weight-bold) var(--sl-icon-typeset-font-size-2xl) /
      var(--sl-text-typeset-line-height-2xl) var(--sl-text-typeset-font-family-body);
    --sl-text-avatar-initials-2xl: var(--sl-text-typeset-font-weight-bold) var(--sl-text-typeset-font-size-2xl) /
      var(--sl-text-typeset-line-height-2xl) var(--sl-text-typeset-font-family-body);
    --sl-text-avatar-initials-xl: var(--sl-text-typeset-font-weight-bold) var(--sl-text-typeset-font-size-xl) /
      var(--sl-text-typeset-line-height-xl) var(--sl-text-typeset-font-family-body);
    --sl-text-avatar-initials-lg: var(--sl-text-typeset-font-weight-bold) var(--sl-text-typeset-font-size-md) /
      var(--sl-text-typeset-line-height-md) var(--sl-text-typeset-font-family-body);
    --sl-text-avatar-initials-md: var(--sl-text-typeset-font-weight-bold) var(--sl-text-typeset-font-size-sm) /
      var(--sl-text-typeset-line-height-sm) var(--sl-text-typeset-font-family-body);
    --sl-text-avatar-initials-sm: var(--sl-text-typeset-font-weight-bold) var(--sl-text-typeset-font-size-xs) /
      var(--sl-text-typeset-line-height-xs) var(--sl-text-typeset-font-family-body);
    ...
    --sl-space-inline-message-inline-end: var(--sl-space-2xl); /* space.button.solid.inline.md */
    --sl-space-inline-message-inline-start: var(--sl-space-lg) + var(--sl-border-width-inline-message-start); /* space.button.solid.inline.md */
    --sl-space-inline-message-block: var(--sl-space-lg); /* space.button.solid.block.md */
    --sl-space-popover-arrow-offset: var(--sl-space-lg);
    --sl-space-popover-offset: var(--sl-space-xs);
    --sl-space-popover-gap: var(--sl-space-xs);
    ...
    --sl-space-badge-label-inline-lg: var(--sl-space-2xs);
    --sl-space-badge-label-inline-md: var(--sl-space-2xs);
    --sl-space-badge-label-inline-sm: var(--sl-space-2xs);
    --sl-space-badge-icon-block-3xl: var(--sl-space-2xs);
    --sl-space-badge-icon-block-xl: var(--sl-space-none);
    --sl-space-badge-icon-block-lg: var(--sl-space-none);
    --sl-space-badge-icon-block-md: var(--sl-space-none);
    --sl-space-badge-icon-block-sm: var(--sl-space-none);
    --sl-space-badge-icon-inline-3xl: var(--sl-space-2xs);
    --sl-space-badge-icon-inline-xl: var(--sl-space-none);
    --sl-space-badge-icon-inline-lg: var(--sl-space-none);
    --sl-space-badge-icon-inline-md: var(--sl-space-none);
    --sl-space-badge-icon-inline-sm: var(--sl-space-none);
    --sl-space-badge-gap-3xl: var(--sl-space-xs) + var(--sl-space-2xs);
    --sl-space-badge-gap-2xl: var(--sl-space-xs) + var(--sl-space-2xs);
    --sl-space-badge-gap-xl: var(--sl-space-xs);
    --sl-space-badge-gap-lg: var(--sl-space-xs);
    --sl-space-badge-gap-sm: var(--sl-space-2xs);
    --sl-space-badge-block-3xl: var(--sl-space-2xs);
    --sl-space-badge-block-2xl: var(--sl-space-2xs);
    --sl-space-badge-block-xl: var(--sl-space-2xs);
    --sl-space-badge-block-lg: var(--sl-space-2xs);
    --sl-space-badge-block-md: var(--sl-space-2xs);
    --sl-space-badge-block-sm: var(--sl-space-2xs);
    --sl-space-badge-inline-2xl: var(--sl-space-2xs);
    --sl-space-badge-inline-xl: var(--sl-space-2xs);
    --sl-space-badge-inline-lg: var(--sl-space-2xs);
    ...
    --sl-space-tooltip-inline: var(--sl-space-md); /* space.button.solid.inline.md */
    ...
    --sl-space-select-listbox-inline-md: var(--sl-space-sm) - var(--sl-border-width-xs);
    --sl-space-select-listbox-inline-lg: var(--sl-space-sm) - var(--sl-border-width-xs);
    --sl-space-select-listbox-block-md: var(--sl-space-sm) - var(--sl-border-width-xs);
    --sl-space-select-listbox-block-lg: var(--sl-space-sm) - var(--sl-border-width-xs);
    ...
    --sl-space-button-bar-gap-block: var(--sl-space-sm);
    ...
    --sl-space-dialog-mobile-body-gap: var(--sl-space-xl); /* space.button.solid.block.md */
    --sl-space-dialog-mobile-body-inline: var(--sl-space-xl); /* space.button.solid.block.md */
    --sl-space-dialog-mobile-body-block: var(--sl-space-xl); /* space.button.solid.block.md */
    ...
    --sl-space-dialog-mobile-container-padding-top: var(--sl-space-xl) * 2; /* space.button.solid.block.md */
    --sl-space-dialog-desktop-body-gap: var(--sl-space-2xl);
    --sl-space-dialog-desktop-body-inline: var(--sl-space-2xl);
    --sl-space-dialog-desktop-body-block: var(--sl-space-2xl); /* space.button.solid.block.md */
    --sl-space-dialog-desktop-container-padding-bottom: var(--sl-space-xl); /* space.button.solid.block.md */
    --sl-space-dialog-desktop-container-inline: var(--sl-space-xl); /* space.button.solid.block.md */
    --sl-space-dialog-desktop-container-padding-top: var(--sl-space-xl); /* space.button.solid.block.md */
    ...
    --sl-space-input-field-label-padding-bottom-lg: var(--sl-space-md); /* 8px */
    --sl-space-input-field-label-padding-bottom-md: var(--sl-space-sm); /* 4px */
    ...
    --sl-space-input-text-field-inline-lg: var(--sl-space-lg) - var(--sl-conceptual-border-width-default); /* space.button.solid.inline.lg */
    --sl-space-input-text-field-inline-md: var(--sl-space-md) - var(--sl-conceptual-border-width-default); /* space.button.solid.inline.md */
    --sl-space-input-text-field-block-lg: var(--sl-space-sm) - var(--sl-conceptual-border-width-default); /* space.button.solid.block.lg */
    --sl-space-input-text-field-block-md: var(--sl-space-xs) + var(--sl-conceptual-border-width-default); /* space.button.solid.block.md */
    ...
    --sl-space-button-link-icon-only-lg: var(--sl-space-sm) - var(--sl-border-width-button-link);
    --sl-space-button-link-icon-only-md: var(--sl-space-sm) - var(--sl-border-width-button-link);
    --sl-space-button-link-icon-only-sm: var(--sl-space-xs) - var(--sl-border-width-button-link);
    ...
    --sl-space-button-link-block-lg: var(--sl-space-sm) - var(--sl-border-width-button-link); /* space.button.solid.block.lg */
    --sl-space-button-link-block-md: var(--sl-space-sm) - var(--sl-border-width-button-link); /* space.button.solid.block.md */
    --sl-space-button-link-block-sm: var(--sl-space-xs) - var(--sl-border-width-button-link); /* space.button.solid.block.sm */
    ...
    --sl-space-button-ghost-icon-only-lg: var(--sl-space-sm) - var(--sl-border-width-button-ghost);
    --sl-space-button-ghost-icon-only-md: var(--sl-space-sm) - var(--sl-border-width-button-ghost);
    --sl-space-button-ghost-icon-only-sm: var(--sl-space-xs) - var(--sl-border-width-button-ghost);
    --sl-space-button-ghost-inline-lg: var(--sl-space-md) - var(--sl-border-width-button-ghost); /* space.button.solid.inline.lg */
    --sl-space-button-ghost-inline-md: var(--sl-space-sm) - var(--sl-border-width-button-ghost); /* space.button.solid.inline.md */
    --sl-space-button-ghost-inline-sm: var(--sl-space-sm) - var(--sl-border-width-button-ghost); /* space.button.solid.inline.sm */
    --sl-space-button-ghost-block-lg: var(--sl-space-sm) - var(--sl-border-width-button-ghost); /* space.button.solid.block.lg */
    --sl-space-button-ghost-block-md: var(--sl-space-sm) - var(--sl-border-width-button-ghost); /* space.button.solid.block.md */
    --sl-space-button-ghost-block-sm: var(--sl-space-xs) - var(--sl-border-width-button-ghost); /* space.button.solid.block.sm */
    --sl-space-button-outline-icon-only-lg: var(--sl-space-sm) - var(--sl-border-width-button-outline);
    --sl-space-button-outline-icon-only-md: var(--sl-space-sm) - var(--sl-border-width-button-outline);
    --sl-space-button-outline-icon-only-sm: var(--sl-space-xs) - var(--sl-border-width-button-outline);
    --sl-space-button-outline-inline-lg: var(--sl-space-md) - var(--sl-border-width-button-outline); /* space.button.solid.inline.lg */
    --sl-space-button-outline-inline-md: var(--sl-space-sm) - var(--sl-border-width-button-outline); /* space.button.solid.inline.md */
    --sl-space-button-outline-inline-sm: var(--sl-space-sm) - var(--sl-border-width-button-outline); /* space.button.solid.inline.sm */
    --sl-space-button-outline-block-lg: var(--sl-space-sm) - var(--sl-border-width-button-outline); /* space.button.solid.block.lg */
    --sl-space-button-outline-block-md: var(--sl-space-sm) - var(--sl-border-width-button-outline); /* space.button.solid.block.md */
    --sl-space-button-outline-block-sm: var(--sl-space-xs) - var(--sl-border-width-button-outline); /* space.button.solid.block.sm */
    --sl-space-button-solid-icon-only-lg: var(--sl-space-sm) - var(--sl-border-width-button-solid);
    --sl-space-button-solid-icon-only-md: var(--sl-space-sm) - var(--sl-border-width-button-solid);
    --sl-space-button-solid-icon-only-sm: var(--sl-space-xs) - var(--sl-border-width-button-solid);
    --sl-space-button-solid-inline-lg: var(--sl-space-xl) - var(--sl-border-width-button-solid); /* space.button.solid.inline.lg */
    --sl-space-button-solid-inline-md: var(--sl-space-xl) - var(--sl-border-width-button-solid); /* space.button.solid.inline.md */
    --sl-space-button-solid-inline-sm: var(--sl-space-lg) - var(--sl-border-width-button-solid); /* space.button.solid.inline.sm */
    --sl-space-button-solid-block-lg: var(--sl-space-sm) - var(--sl-border-width-button-solid); /* space.button.solid.block.lg */
    --sl-space-button-solid-block-md: var(--sl-space-sm) - var(--sl-border-width-button-solid); /* space.button.solid.block.md */
    --sl-space-button-solid-block-sm: var(--sl-space-xs) - var(--sl-border-width-button-solid); /* space.button.solid.block.sm */
    ...
    --sl-size-badge-3xl: var(--sl-size-lg);
    --sl-size-badge-xl: var(--sl-size-md);
    --sl-size-badge-lg: var(--sl-size-sm);
    --sl-size-badge-md: var(--sl-size-xs);
    ...
    --sl-size-input-switch-handle-lg: var(--sl-size-2xl) - (2 * var(--sl-space-input-switch-padding-controller)); /* size.input.md */
    --sl-size-input-switch-handle-md: var(--sl-size-xl) - (2 * var(--sl-space-input-switch-padding-controller)); /* size.input.md */
    --sl-size-input-switch-handle-sm: var(--sl-size-md) - (2 * var(--sl-space-input-switch-padding-controller)); /* size.input.md */
    ...
    --sl-border-width-dividerr: var(--sl-border-width-xs);
    ...
    --sl-border-radius-focusring-checkbox: var(--sl-border-radius-checkbox) + 1px;
    --sl-border-radius-focusring-default: var(--sl-border-radius-default) + 1px;
    --sl-border-radius-popover-default: var(--sl-border-radius-default); /* borderRadius.button */
    --sl-text-icon-font-icon-lg: var(--sl-text-typeset-font-weight-regular) var(--sl-text-typeset-line-height-sm) /
      var(--sl-text-typeset-font-size-lg) var(--sl-text-typeset-font-family-icon);
    --sl-text-icon-font-icon-md: var(--sl-text-typeset-font-weight-regular) var(--sl-text-typeset-line-height-xs) /
      var(--sl-text-typeset-font-size-md) var(--sl-text-typeset-font-family-icon);
    --sl-text-icon-font-icon-sm: var(--sl-text-typeset-font-weight-regular) 13px / var(--sl-text-typeset-line-height-xxs)
      var(--sl-text-typeset-font-family-icon);
    --sl-text-input-helper-font-icon-lg: var(--sl-text-typeset-font-weight-icon-solid) 18px /
    ...
    --sl-text-input-text-field-font-icon-lg: var(--sl-text-typeset-font-weight-icon-solid) 18px /
      var(--sl-text-typeset-line-height-md) var(--sl-text-typeset-font-family-icon);
    --sl-text-avatar-icon-3xl: var(--sl-icon-style-outline) var(--sl-icon-typeset-font-size-2xl) / 1
      var(--sl-text-typeset-font-family-icon);
    --sl-text-avatar-icon-2xl: var(--sl-icon-style-outline) var(--sl-icon-typeset-font-size-2xl) / 1
      var(--sl-text-typeset-font-family-icon);
    --sl-text-avatar-icon-xl: var(--sl-icon-style-outline) var(--sl-text-typeset-font-size-2xl) / 1
      var(--sl-text-typeset-font-family-icon);
    --sl-text-avatar-icon-lg: var(--sl-icon-style-outline) var(--sl-text-typeset-font-size-xl) / 1
      var(--sl-text-typeset-font-family-icon);
    --sl-text-avatar-icon-md: var(--sl-icon-style-outline) var(--sl-text-typeset-font-size-lg) / 1
      var(--sl-text-typeset-font-family-icon);
    --sl-text-avatar-icon-sm: var(--sl-icon-style-outline) var(--sl-text-typeset-font-size-md) / 1
      var(--sl-text-typeset-font-family-icon);
    ...
    --sl-space-button-bar-gap-inline: var(--sl-space-button-bar-gap-block);
    --sl-space-input-switch-padding-row-lg: var(--sl-space-input-switch-margin-left) +
      var(--sl-size-input-switch-controller-width-lg) + (var(--sl-space-input-switch-padding-container) * 2); /* space.switch.padding.outer */
    --sl-space-input-switch-padding-row-md: var(--sl-space-input-switch-margin-left) +
      var(--sl-size-input-switch-controller-width-md) + (var(--sl-space-input-switch-padding-container) * 2); /* space.switch.padding.outer */
    --sl-space-input-switch-padding-row-sm: var(--sl-space-input-switch-margin-left) +
      var(--sl-size-input-switch-controller-width-sm) + (var(--sl-space-input-switch-padding-container) * 2); /* space.switch.padding.outer */
  ...
  @media (prefers-color-scheme: light) {
    :host {
      --sl-body-surface-overlay: rgba(var(--sl-color-palette-primary-base), var(--sl-opacity-700)); /* body.surface.200 */
      ...
      --sl-color-accordion-active-border: var(--sl-color-palette-neutral-100);
      ...
      --sl-color-accordion-disabled-border: var(--sl-color-palette-neutral-100);
      --sl-color-accordion-disabled-icon: var(--sl-color-palette-neutral-200);
      --sl-color-accordion-disabled-foreground: var(--sl-color-palette-neutral-200);
      --sl-color-accordion-hover-border: var(--sl-color-palette-neutral-100);
      ...
      --sl-color-accordion-default-border: var(--sl-color-palette-neutral-100);
      --sl-color-card-border: var(--sl-color-palette-neutral-100);
      ...
      --sl-color-inline-message-warning-icon: var(--sl-color-palette-warning-400);
      ...
      --sl-color-inline-message-warning-background: var(--sl-color-palette-warning-50);
      ...
      --sl-color-inline-message-info-icon: var(--sl-color-palette-info-base);
      --sl-color-inline-message-info-border: var(--sl-color-palette-info-base);
      ...
      --sl-color-popover-border: var(--sl-color-palette-neutral-150);
      ...
      --sl-color-tooltip-background: var(--sl-color-palette-accent-600);
      --sl-color-select-listbox-background: var(--sl-color-palette-white-base);
      --sl-color-select-listbox-border: var(--sl-color-palette-neutral-100);
      ...
      --sl-color-select-item-divider-line: var(--sl-color-palette-neutral-100);
      ...
      --sl-color-input-text-field-valid-active-background: rgba(
        var(--sl-color-palette-success-base),
        var(--sl-opacity-100)
      ); /* color.surface.solid.primary.background */
      --sl-color-input-text-field-valid-hover-background: rgba(
        var(--sl-color-palette-success-base),
        var(--sl-opacity-300)
      ); /* color.surface.solid.primary.background */
      ...
      --sl-color-input-text-field-invalid-active-background: rgba(
        var(--sl-color-palette-danger-base),
        var(--sl-opacity-100)
      ); /* color.surface.solid.primary.background */
      --sl-color-input-text-field-invalid-hover-background: rgba(
        var(--sl-color-palette-danger-base),
        var(--sl-opacity-300)
      ); /* color.surface.solid.primary.background */
      ...
      --sl-color-input-text-field-default-active-background: rgba(
        var(--sl-color-palette-accent-base),
        var(--sl-opacity-100)
      ); /* color.surface.solid.primary.background */
      --sl-color-input-text-field-default-hover-icon: var(
        --sl-color-palette-neutral-400
      ); /* color.surface.solid.primary.background */
      --sl-color-input-text-field-default-hover-background: rgba(
        var(--sl-color-palette-accent-base),
        var(--sl-opacity-300)
      ); /* color.surface.solid.primary.background */
      ...
      --sl-color-input-option-valid-unchecked-active-background: rgba(
        var(--sl-color-palette-success-base),
        var(--sl-opacity-300)
      ); /* color.surface.solid.primary.background */
      ...
      --sl-color-input-option-valid-unchecked-hover-background: rgba(
        var(--sl-color-palette-success-base),
        var(--sl-opacity-200)
      ); /* color.surface.solid.primary.background */
      ...
      --sl-color-input-option-invalid-unchecked-active-background: rgba(
        var(--sl-color-palette-danger-base),
        var(--sl-opacity-400)
      ); /* color.surface.solid.primary.background */
      ...
      --sl-color-input-option-invalid-unchecked-hover-background: rgba(
        var(--sl-color-palette-danger-base),
        var(--sl-opacity-200)
      ); /* color.surface.solid.primary.background */
      ...
      --sl-color-input-option-default-unchecked-focus-background: rgba(
        var(--sl-color-palette-accent-base),
        var(--sl-opacity-100)
      ); /* color.surface.solid.primary.background */
      --sl-color-input-option-default-unchecked-active-icon: var(
        --sl-color-palette-accent-700
      ); /* color.surface.solid.primary.background */
      --sl-color-input-option-default-unchecked-active-border: var(
        --sl-color-palette-accent-600
      ); /* color.surface.solid.primary.background */
      --sl-color-input-option-default-unchecked-active-background: rgba(
        var(--sl-color-palette-accent-base),
        var(--sl-opacity-400)
      ); /* color.surface.solid.primary.background */
      ...
      --sl-color-badge-primary-foreground: var(--sl-color-palette-white-base);
      --sl-color-badge-primary-background: var(--sl-color-palette-primary-base);
      --sl-color-badge-neutral-foreground: var(--sl-color-palette-black-base);
      --sl-color-badge-neutral-background: var(--sl-color-palette-neutral-200);
      --sl-color-badge-accent-foreground: var(--sl-color-palette-white-base);
      --sl-color-badge-accent-background: var(--sl-color-palette-accent-base);
      --sl-color-badge-warning-foreground: var(--sl-color-palette-black-base);
      --sl-color-badge-warning-background: var(--sl-color-palette-warning-base);
      --sl-color-badge-success-foreground: var(--sl-color-palette-white-base);
      --sl-color-badge-success-background: var(--sl-color-palette-success-500);
      --sl-color-badge-danger-foreground: var(--sl-color-palette-white-base);
      --sl-color-badge-danger-background: var(--sl-color-palette-danger-500);
      --sl-color-badge-info-foreground: var(--sl-color-palette-white-base);
      ...
      --sl-box-shadow-focus: 0 0 0 3px rgba(51, 102, 255, var(--sl-opacity-500)); /* boxShadow.focus */
      --sl-box-shadow-slds-checklist: 0 0 4px 0 rgba(34, 34, 34, var(--sl-opacity-50)),
        0 4px 8px 0 rgba(34, 34, 34, var(--sl-opacity-150));
      ...
      --sl-color-select-item-disabled-border: rgba(var(--sl-body-background), var(--sl-opacity-transparent));
      --sl-color-select-item-disabled-background: rgba(var(--sl-body-background), var(--sl-opacity-transparent));
      --sl-color-select-item-focus-border: rgba(var(--sl-body-background), var(--sl-opacity-transparent));
      --sl-color-select-item-focus-background: rgba(var(--sl-body-background), var(--sl-opacity-100));
      --sl-color-select-item-active-border: rgba(var(--sl-body-background), var(--sl-opacity-transparent));
      --sl-color-select-item-hover-border: rgba(var(--sl-body-background), var(--sl-opacity-transparent));
      --sl-color-select-item-default-border: rgba(var(--sl-body-background), var(--sl-opacity-transparent));
      --sl-color-select-item-default-background: rgba(var(--sl-body-background), var(--sl-opacity-transparent));
      ...
      --sl-color-input-text-field-default-disabled-background: rgba(
      ...
      --sl-color-input-option-valid-unchecked-focus-background: rgba(
        var(--sl-body-background),
        var(--sl-opacity-100)
      ); /* color.surface.solid.primary.background */
      ...
      --sl-color-input-option-invalid-unchecked-focus-background: rgba(
        var(--sl-body-background),
        var(--sl-opacity-100)
      ); /* color.surface.solid.primary.background */
      ...
      --sl-color-input-option-default-unchecked-disabled-background: rgba(
        var(--sl-body-background),
        var(--sl-opacity-200)
      ); /* color.surface.solid.primary.background */
      ...
      --sl-color-badge-info-background: var(--sl-color-palette-info-400);
  ...
  @media (prefers-color-scheme: dark) {
    :host {
      --sl-body-surface-overlay: rgba(var(--sl-color-palette-white-base), var(--sl-opacity-500)); /* body.surface.200 */
      ...
      --sl-color-select-listbox-background: var(--sl-color-palette-neutral-900);
      --sl-color-select-listbox-border: var(--sl-color-palette-neutral-600);
      --sl-color-select-selectbox-default-focus-border: var(--sl-color-palette-primary-base);
      --sl-color-select-selectbox-default-active-border: var(--sl-color-palette-primary-base);
      --sl-color-select-item-group-title-foreground: var(--sl-color-palette-neutral-200);
      --sl-color-select-item-divider-line: var(--sl-color-palette-neutral-600);
      --sl-color-select-item-disabled-indicator: var(--sl-color-palette-neutral-300);
      --sl-color-select-item-disabled-foreground: var(--sl-color-palette-neutral-300);
      --sl-color-select-item-focus-indicator: var(--sl-color-palette-accent-base);
      --sl-color-select-item-focus-foreground: var(--sl-color-palette-neutral-600)
      ...
      --sl-color-select-item-active-indicator: var(--sl-color-palette-accent-base);
      --sl-color-select-item-active-background: rgba(var(--sl-color-palette-accent-base), var(--sl-opacity-700));
      --sl-color-select-item-hover-indicator: var(--sl-color-palette-accent-base);
      --sl-color-select-item-hover-background: rgba(var(--sl-color-palette-accent-base), var(--sl-opacity-500));
      --sl-color-select-item-default-indicator: var(--sl-color-palette-accent-base);
      --sl-color-inline-message-danger-icon: var(--sl-color-palette-danger-base);
      --sl-color-inline-message-danger-border: var(--sl-color-palette-danger-base);
      --sl-color-inline-message-danger-foreground: var(--sl-color-palette-danger-150);
      --sl-color-inline-message-danger-background: var(--sl-color-palette-danger-800);
      --sl-color-inline-message-warning-icon: var(--sl-color-palette-warning-base);
      --sl-color-inline-message-warning-border: var(--sl-color-palette-warning-base);
      --sl-color-inline-message-warning-foreground: var(--sl-color-palette-warning-150);
      --sl-color-inline-message-warning-background: var(--sl-color-palette-warning-800);
      --sl-color-inline-message-success-icon: var(--sl-color-palette-success-base);
      --sl-color-inline-message-success-border: var(--sl-color-palette-success-base);
      --sl-color-inline-message-success-foreground: var(--sl-color-palette-success-150);
      --sl-color-inline-message-success-background: var(--sl-color-palette-success-800);
      --sl-color-inline-message-info-icon: var(--sl-color-palette-info-base);
      --sl-color-inline-message-info-border: var(--sl-color-palette-info-base);
      --sl-color-inline-message-info-foreground: var(--sl-color-palette-info-150);
      --sl-color-inline-message-info-background: var(--sl-color-palette-info-900);
      --sl-color-popover-border: var(--sl-color-palette-neutral-700);
      --sl-color-popover-background: var(--sl-color-palette-neutral-900);
      --sl-color-focusring-default: var(--sl-color-palette-accent-300);
      --sl-color-tooltip-border: var(--sl-color-palette-transparent-base);
      --sl-color-tooltip-foreground: var(--sl-color-palette-black-base);
      --sl-color-tooltip-background: var(--sl-color-palette-accent-200);
      --sl-color-input-field-label-icon-disabled: var(
        --sl-color-palette-neutral-200
      ); /* color.surface.solid.primary.foreground */
      --sl-color-input-field-label-text-disabled: var(
      ...
      --sl-color-input-option-default-unchecked-hover-background: rgba(
        var(--sl-color-palette-accent-base),
        var(--sl-opacity-200)
      ); /* color.surface.solid.primary.background */
      --sl-color-input-option-default-unchecked-default-border: var(
      ...
      --sl-color-button-danger-link-focus-border: var(
        --sl-color-palette-transparent-base
      ); /* color.button.default.focus.border */
      --sl-color-button-danger-link-focus-foreground: var(
        --sl-color-palette-danger-base
      ); /* color.button.default.focus.foreground */
      --sl-color-button-danger-link-focus-background: var(
        --sl-color-palette-transparent-base
      ); /* color.button.default.focus.background */
      --sl-color-button-danger-link-active-border: var(
        --sl-color-palette-transparent-base
      ); /* color.button.danger.outline.active.border */
      --sl-color-button-danger-link-active-foreground: var(
      ...
      --sl-color-button-danger-ghost-focus-border: var(
        --sl-color-palette-transparent-base
      ); /* color.button.default.focus.border */
      --sl-color-button-danger-ghost-focus-foreground: var(
        --sl-color-palette-danger-base
      ); /* color.button.default.focus.foreground */
      --sl-color-button-danger-ghost-focus-background: var(
        --sl-color-palette-transparent-base
      ); /* color.button.default.focus.background */
      --sl-color-button-danger-ghost-active-border: var(
        --sl-color-palette-transparent-base
      ...
      --sl-color-button-danger-outline-focus-border: var(
        --sl-color-palette-info-base
      ); /* color.button.default.focus.border */
      --sl-color-button-danger-outline-focus-foreground: var(
        --sl-color-palette-danger-base
      ); /* color.button.default.focus.foreground */
      --sl-color-button-danger-outline-active-border: var(
        --sl-color-palette-danger-200
      ...
      --sl-color-button-danger-solid-focus-foreground: var(
        --sl-color-palette-black-base
      ); /* color.button.default.focus.foreground */
      --sl-color-button-danger-solid-active-border: var(
        --sl-color-palette-danger-200
      ...
      --sl-color-button-warning-link-focus-border: var(
        --sl-color-palette-transparent-base
      ); /* color.button.default.focus.border */
      --sl-color-button-warning-link-focus-foreground: var(
        --sl-color-palette-warning-150
      ); /* color.button.default.focus.foreground */
      --sl-color-button-warning-link-focus-background: var(
        --sl-color-palette-transparent-base
      ); /* color.button.default.focus.background */
      --sl-color-button-warning-link-active-border: var(
        --sl-color-palette-transparent-base
      ...
      --sl-color-button-warning-ghost-focus-border: var(
        --sl-color-palette-transparent-base
      ); /* color.button.default.focus.border */
      --sl-color-button-warning-ghost-focus-foreground: var(
        --sl-color-palette-warning-150
      ); /* color.button.default.focus.foreground */
      --sl-color-button-warning-ghost-focus-background: var(
        --sl-color-palette-transparent-base
      ); /* color.button.default.focus.background */
      --sl-color-button-warning-ghost-active-border: var(
        --sl-color-palette-transparent-base
      ...
      --sl-color-button-warning-outline-focus-border: var(
        --sl-color-palette-info-base
      ); /* color.button.default.focus.border */
      --sl-color-button-warning-outline-focus-foreground: var(
        --sl-color-palette-warning-150
      ); /* color.button.default.focus.foreground */
      --sl-color-button-warning-outline-active-border: var(
        --sl-color-palette-warning-150
      ...
      --sl-color-button-warning-solid-focus-border: var(
        --sl-color-palette-info-base
      ); /* color.button.default.focus.border */
      --sl-color-button-warning-solid-focus-foreground: var(
        --sl-color-palette-black-base
      ); /* color.button.default.focus.foreground */
      --sl-color-button-warning-solid-focus-background: var(
        --sl-color-palette-warning-150
      ); /* color.button.default.focus.background */
      --sl-color-button-warning-solid-active-border: var(
        --sl-color-palette-warning-100
      ...
      --sl-color-button-success-link-focus-border: var(
        --sl-color-palette-transparent-base
      ); /* color.button.default.focus.border */
      --sl-color-button-success-link-focus-foreground: var(
        --sl-color-palette-success-200
      ); /* color.button.default.focus.foreground */
      --sl-color-button-success-link-focus-background: var(
        --sl-color-palette-transparent-base
      ); /* color.button.default.focus.background */
      --sl-color-button-success-link-active-border: var(
        --sl-color-palette-transparent-base
      ...
      --sl-color-button-success-ghost-focus-border: var(
        --sl-color-palette-transparent-base
      ); /* color.button.default.focus.border */
      --sl-color-button-success-ghost-focus-foreground: var(
        --sl-color-palette-success-200
      ); /* color.button.default.focus.foreground */
      --sl-color-button-success-ghost-focus-background: var(
        --sl-color-palette-transparent-base
      ); /* color.button.default.focus.background */
      --sl-color-button-success-ghost-active-border: var(
        --sl-color-palette-transparent-base
      ...
      --sl-color-button-success-outline-focus-border: var(
        --sl-color-palette-accent-base
      ); /* color.button.default.focus.border */
      --sl-color-button-success-outline-focus-foreground: var(
        --sl-color-palette-success-200
      ); /* color.button.default.focus.foreground */
      --sl-color-button-success-outline-active-border: var(
        --sl-color-palette-success-150
      ...
      --sl-color-button-success-solid-focus-border: var(
        --sl-color-palette-info-base
      ); /* color.button.default.focus.border */
      --sl-color-button-success-solid-focus-foreground: var(
        --sl-color-palette-black-base
      ); /* color.button.default.focus.foreground */
      --sl-color-button-success-solid-focus-background: var(
        --sl-color-palette-success-200
      ); /* color.button.default.focus.background */
      --sl-color-button-success-solid-active-border: var(
        --sl-color-palette-success-100
      ...
      --sl-color-button-primary-link-focus-border: var(
        --sl-color-palette-transparent-base
      ); /* color.button.default.focus.border */
      --sl-color-button-primary-link-focus-foreground: var(
        --sl-color-palette-accent-300
      ); /* color.button.default.focus.foreground */
      --sl-color-button-primary-link-focus-background: var(
        --sl-color-palette-transparent-base
      ); /* color.button.default.focus.background */
      --sl-color-button-primary-link-active-border: var(
        --sl-color-palette-transparent-base
      ...
      --sl-color-button-primary-ghost-focus-border: var(
        --sl-color-palette-transparent-base
      ); /* color.button.default.focus.border */
      --sl-color-button-primary-ghost-focus-foreground: var(
        --sl-color-palette-accent-300
      ); /* color.button.default.focus.foreground */
      --sl-color-button-primary-ghost-focus-background: var(
        --sl-color-palette-transparent-base
      ); /* color.button.default.focus.background */
      --sl-color-button-primary-ghost-active-border: var(
        --sl-color-palette-transparent-base
      ...
      --sl-color-button-primary-outline-focus-border: var(
        --sl-color-palette-info-base
      ); /* color.button.default.focus.border */
      --sl-color-button-primary-outline-focus-foreground: var(
        --sl-color-palette-accent-300
      ); /* color.button.default.focus.foreground */
      --sl-color-button-primary-outline-active-border: var(
        --sl-color-palette-white-base
      ...
      --sl-color-button-primary-solid-focus-border: var(
        --sl-color-palette-info-300
      ); /* color.button.primary.default.focus.border */
      --sl-color-button-primary-solid-focus-foreground: var(
        --sl-color-palette-black-base
      ); /* color.button.primary.default.focus.foreground */
      --sl-color-button-primary-solid-focus-background: var(
        --sl-color-palette-accent-300
      ); /* color.button.primary.default.focus.background */
      --sl-color-button-primary-solid-active-border: var(
        --sl-color-palette-accent-100
      ); /* color.button.primary.default.active.border */
      --sl-color-button-primary-solid-active-foreground: var(
      ...
      --sl-color-button-default-link-focus-border: var(
        --sl-color-palette-transparent-base
      ); /* color.button.default.focus.border */
      --sl-color-button-default-link-focus-foreground: var(
        --sl-color-palette-neutral-150
      ); /* color.button.default.focus.foreground */
      --sl-color-button-default-link-focus-background: var(
        --sl-color-palette-transparent-base
      ); /* color.button.default.focus.background */
      --sl-color-button-default-link-active-border: var(
        --sl-color-palette-transparent-base
      ...
      --sl-color-button-default-ghost-focus-border: var(
        --sl-color-palette-transparent-base
      ); /* color.button.default.focus.border */
      --sl-color-button-default-ghost-focus-foreground: var(
        --sl-color-palette-neutral-150
      ); /* color.button.default.focus.foreground */
      --sl-color-button-default-ghost-focus-background: var(
        --sl-color-palette-transparent-base
      ); /* color.button.default.focus.background */
      --sl-color-button-default-ghost-active-border: var(
        --sl-color-palette-transparent-base
      ...
      --sl-color-button-default-outline-focus-border: var(
        --sl-color-palette-info-base
      ); /* color.button.default.focus.border */
      --sl-color-button-default-outline-focus-foreground: var(
        --sl-color-palette-neutral-150
      ); /* color.button.default.focus.foreground */
      --sl-color-button-default-outline-active-border: var(
        --sl-color-palette-accent-200
      ...
      --sl-color-button-default-solid-focus-border: var(
        --sl-color-palette-info-base
      ); /* color.button.default.focus.border */
      --sl-color-button-default-solid-focus-foreground: var(
        --sl-color-palette-neutral-150
      ); /* color.button.default.focus.foreground */
      --sl-color-button-default-solid-active-border: var(
        --sl-color-palette-accent-200
      ...
      --sl-color-badge-danger-background: var(--sl-color-palette-danger-500);
      --sl-color-badge-info-foreground: var(--sl-color-palette-white-base);
      --sl-color-badge-info-background: var(--sl-color-palette-info-500);
      --sl-color-avatar-foreground: var(--sl-color-palette-black-base);
      --sl-color-avatar-background: var(--sl-color-palette-accent-300);
      --sl-box-shadow-none: 0 0 0 0 var(--sl-color-palette-transparent-base); /* boxShadow.none */
      --sl-box-shadow-focus: 0 0 0 3px rgba(51, 102, 255, var(--sl-opacity-800));
      ...
      --sl-color-input-text-field-invalid-disabled-icon: var(
        --sl-color-input-text-field-invalid-disabled-border
      ); /* color.surface.solid.primary.background */
      --sl-color-input-text-field-invalid-disabled-label: var(
        --sl-color-input-text-field-default-disabled-label
      ); /* color.surface.solid.primary.foreground */
      ...
      --sl-color-button-danger-outline-focus-background: var(
        --sl-body-background
      ); /* color.button.default.focus.background */
      --sl-color-button-danger-outline-idle-background: var(
        --sl-body-background
      ...
      --sl-color-button-danger-solid-focus-border: var(
        --sl-color-palette-danger-300
      ); /* color.button.default.focus.border */
      --sl-color-button-danger-solid-focus-background: var(
        --sl-color-palette-danger-300
      ); /* color.button.default.focus.background */
      --sl-color-button-warning-outline-disabled-background: var(
        --sl-body-background
      ); /* color.button.warning.outline.disabled.background */
      --sl-color-button-warning-outline-focus-background: var(
        --sl-body-background
      ); /* color.button.default.focus.background */
      --sl-color-button-warning-outline-idle-background: var(
        --sl-body-background
      ...
      --sl-color-button-success-outline-focus-background: var(
        --sl-body-background
      ); /* color.button.default.focus.background */
      --sl-color-button-success-outline-idle-background: var(
        --sl-body-background
      ); /* color.button.success.outline.idle.background */
      --sl-color-button-primary-outline-focus-background: var(
        --sl-body-background
      ); /* color.button.default.focus.background */
      --sl-color-button-primary-outline-idle-background: var(
        --sl-body-background
      ...
      --sl-color-button-default-outline-focus-background: var(
        --sl-body-background
      ); /* color.button.default.focus.background */
      --sl-color-button-default-outline-idle-background: var(
        --sl-body-background
      ); /* color.button.default.outline.idle.background */
      --sl-color-button-default-solid-focus-background: var(
        --sl-body-background
      ); /* color.button.default.focus.background */
      --sl-color-button-default-solid-idle-background: var(
        --sl-body-background
