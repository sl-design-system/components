...
export default css`
  ...
  :host {
    ...
    --sl-text-tag-close-lg: var(--sl-text-typeset-font-weight-icon-solid) var(--sl-text-typeset-font-size-md) /
      var(--sl-text-typeset-line-height-md) var(--sl-text-typeset-fontFamily-icon);
    --sl-elevation-shadow-overflow: 0 0 15px 0 rgba(var(--sl-elevation-surface-shadow), var(--sl-opacity-subtlest)); /* Use to create a shadow when the content scrolls under other content. */
    --sl-elevation-shadow-overlay:
      0 6px 12px -3px rgba(var(--sl-elevation-surface-shadow), 4%),
      0 6px 18px 0 rgba(var(--sl-elevation-surface-shadow), 12%); /* Use for the box shadow of elements that sit on top of the UI, such as dialogs, cards, menus and drawers. */
  ...
  @media (prefers-color-scheme: light) {
    :host {
      ...
      --sl-color-field-button-default-active-background: rgb(34 34 34 / 13%); /* color.button.default.active.background */
  ...
  @media (prefers-color-scheme: dark) {
    :host {
      ...
      --sl-color-field-button-default-hover-background: rgb(255 255 255 / 7%); /* color.button.default.hover.background */
