    ...
    return html`
      <sl-accordion ?single=${single}>
        ...
        <sl-accordion-item summary="Math Magic - solving Puzzles with numbers">
          ...
          polygons become our guides. Their angles converse, and symmetry weaves intricate spells. The language of
          geometry paints landscapes where lines intersect and circles embrace. Fractals and Prime Whispers: Beyond
          equations, we encounter fractals—a self-similar universe within each curve. Prime numbers stand sentinel,
          guarding mathematical secrets. Each concept, like a star in the night sky, beckons us to unravel its mystery.
          The Joy of Discovery: Math isn’t a mere tool; it’s an adventure. With every puzzle solved, we glimpse the
          magic that shapes our world. So let’s wander through numerical enchantment, our minds alight with curiosity.
          Remember, in this mystical realm, numbers are more than symbols—they’re gateways to wonder! 🌟✨
        </sl-accordion-item>
    ...
    return html`
      ...
      <sl-accordion ?single=${single}>
        ...
        <sl-accordion-item summary="Art Quest: Painting, Drawing, and Sculpting">
          ...
          pellentesque velit at sagittis mattis. Nam ut tellus elit. Proin luctus lectus velit, ut ultricies libero
          blandit blandit. Aenean molestie est ipsum, in dictum turpis dictum nec. Curabitur eu convallis quam. Proin
          efficitur velit nec quam ornare, id volutpat ex ornare.
        </sl-accordion-item>
