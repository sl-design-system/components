...
export default css`
  :host {
    align-items: center;
    background: var(--_background, var(--sl-color-background-accent-grey-subtle));
    block-size: 1lh;
    border-radius: var(--sl-size-borderRadius-full);
    color: var(--_color, var(--sl-color-foreground-accent-grey-bold));
    display: inline-flex;
    font-size: 0.857em;
    gap: var(--sl-size-025);
  ...
  :host([variant='primary'][emphasis='bold']) {
  ...
  :host([variant='success'][emphasis='bold']) {
  ...
  :host([variant='danger'][emphasis='bold']) {
  ...
  :host([size='lg']) {
    ...
    gap: var(--sl-size-050);
    line-height: 1lh;
    min-inline-size: calc(1lh + var(--sl-size-050));
    padding: var(--sl-size-025) var(--sl-size-100);
  }

  :host([size='lg']) ::slotted(sl-icon) {
  ...
  :host([size='sm'][round])::before {
    background: var(--_background, var(--sl-color-background-accent-grey-subtle));
    block-size: var(--sl-size-100);
    border-radius: 50%;
    content: '';
    display: inline-flex;
    inline-size: var(--sl-size-100);
    margin-block-start: calc(0.8em - var(--sl-size-100));
    margin-inline-end: var(--sl-size-050);
  }

  @supports (inline-size: 1cap) {
    :host([size='sm'][round])::before {
      margin-block-start: calc(1cap - var(--sl-size-100));
    }
  }
