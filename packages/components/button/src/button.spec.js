...
describe('sl-button', () => {
  ...
  describe('defaults', () => {
    ...
    it('should emit a click event on mouse click', async () => {
      const button2 = el.renderRoot.querySelector('button'),
        onClick = spy();
  ...
  describe('disabled', () => {
    ...
    it('should prevent click events from bubbling up the DOM', async () => {
      const el2 = await fixture(html`<sl-button disabled>Hello world</sl-button>`),
      ...
      el2.renderRoot.querySelector('button')?.dispatchEvent(clickEvent);
    ...
    it('should suppress events in the capture phase when disabled', async () => {
      ...
      `);
      const button2 = wrapper.querySelector('sl-button'),
        innerButton = button2?.renderRoot.querySelector('button');
  ...
  describe('invoker API', () => {
    ...
    it('should set commandForElement on the inner button when commandFor matches a sibling element', async () => {
      ...
      expect(button2).to.have.property('commandForElement', target);
    });
  ...
  describe('native form integration', () => {
    ...
    describe('button type', () => {
      ...
      it('should not interact with the form when clicked', () => {
        const requestSubmit = stub(form, 'requestSubmit').returns(void 0),
          reset = stub(form, 'reset').returns(void 0);
        button.click();
    ...
    describe('reset type', () => {
      ...
      it('should call reset() on the form when clicked', () => {
        const reset = stub(form, 'reset').returns(void 0);
        button.click();
  ...
  describe('tooltip', () => {
    ...
    it('should include both the tooltip and aria-describedby element in ariaDescribedByElements', async () => {
      ...
      const button2 = el.renderRoot.querySelector('button'),
        ...
        span = wrapper.querySelector('#icon-btn-label');
      expect(button2.ariaDescribedByElements).to.include(span);
      expect(button2.ariaDescribedByElements).to.include(tooltip);
    });
