  ...
  render: ({ fill, shape, size, variant }) => {
    return html`
      <p>
        ...
        <code>aria-disabled</code> attribute. This button is also visually disabled and cannot be interacted with, but you can still focus it.
        This second button can be used in combination with a tooltip to explain why the button is disabled.
      </p>
