...
describe('sl-select-year', () => {
  ...
  describe('defaults', () => {
    ...
    it('should emit sl-select with selected year on click', () => {
      ...
      el.renderRoot.querySelector('table button')?.click();
    ...
    it('should emit sl-select with selected year on enter', async () => {
      ...
      const button = el.renderRoot.querySelector('table button');
      button?.focus();
  ...
  describe('navigation', () => {
    ...
    it('should go to previous 12 years when previous button clicked', async () => {
      ...
      el.renderRoot.querySelector('sl-button:first-of-type')?.click();
      await el.updateComplete;
    ...
    it('should go to next 12 years when next button clicked', async () => {
      ...
      el.renderRoot.querySelector('sl-button:last-of-type')?.click();
      await el.updateComplete;
  ...
  describe('keyboard navigation', () => {
    ...
    it('should keep column focus when ArrowUp loads previous years', async () => {
      ...
      await userEvent.keyboard('{ArrowUp}');
      await el.updateComplete;
      const newButtons = Array.from(el.renderRoot.querySelectorAll('table button'));
  ...
  describe('dialog tab escape', () => {
    it('should not cycle back to header when tabbing forward from the table', async () => {
      ...
      `);
      const yearPicker = dialog.querySelector('sl-select-year');
      await yearPicker.updateComplete;
      const rightArrow = yearPicker.renderRoot.querySelector('header sl-button:last-of-type');
      rightArrow?.focus();
      await userEvent.keyboard('{Tab}');
      await yearPicker.updateComplete;
      await userEvent.keyboard('{Tab}');
      await yearPicker.updateComplete;
      const activeInsideShadow = yearPicker.shadowRoot?.activeElement;
      expect(activeInsideShadow).to.be.null;
    });
  });
});
//# sourceMappingURL=select-year.spec.js.map
