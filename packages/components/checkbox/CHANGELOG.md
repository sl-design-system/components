...
- [#3605](https://github.com/sl-design-system/components/pull/3605) [`f5207d1`](https://github.com/sl-design-system/components/commit/f5207d132805c4a4e6f7253057babb8cc70705c4) - Added `description` and `tooltip` support to `sl-checkbox` and `sl-radio`:
...
- [#3677](https://github.com/sl-design-system/components/pull/3677) [`064ad56`](https://github.com/sl-design-system/components/commit/064ad561281faab7e431e6316d32759420ac0042) - Align checkbox and radio description typography with their labels and Figma specs.
...
- [#3499](https://github.com/sl-design-system/components/pull/3499) [`8e583d9`](https://github.com/sl-design-system/components/commit/8e583d9894ad680f4a7141a9c9b03bd999993d3b) - Set a minimum border radius of `--sl-size-borderRadius-md` on the small checkbox, to prevent it becoming too round when a theme has a large border radius.
  The checkbox needs to be visibly square to avoid confusion with a radio button.
...
- Updated dependencies [[`659a92a`](https://github.com/sl-design-system/components/commit/659a92af4732d339f9830368b1e0e3bd48221714), [`09a1533`](https://github.com/sl-design-system/components/commit/09a1533558b2e16baa0d118b8348ee444e169854)]:
