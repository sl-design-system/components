    ...
    beforeEach(async () => {
      el = await fixture(html`
        <sl-checkbox-group>
          ...
          <sl-checkbox .value=${void 0}>Option 2</sl-checkbox>
        </sl-checkbox-group>
      `);
    });
    it('should have proper values', () => {
      expect(el.querySelectorAll('sl-checkbox')[0].value).to.equal(null);
      expect(el.querySelectorAll('sl-checkbox')[1].value).to.equal(void 0);
    });
...
//# sourceMappingURL=checkbox-group.spec.js.map
