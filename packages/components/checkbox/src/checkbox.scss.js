...
export default css`
  ...
  :host([size='sm']) [part='outer'] {
    padding-block: 0;
  }

  :host([size='sm']) [part='inner'] {
    block-size: var(--sl-size-250);
    border-radius: min(var(--sl-size-borderRadius-default), var(--sl-size-borderRadius-md));
  }
