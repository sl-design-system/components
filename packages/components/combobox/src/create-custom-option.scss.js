...
export default css`
  ...
  :host(:where(:focus-visible, [current])) [part='container'] {
    outline-color: var(--sl-color-border-focused);
  }

  :host(:where(:hover, :focus-visible, [current])) [part='container']::before {
...
`;
//# sourceMappingURL=create-custom-option.scss.js.map
