...
import { FetchListDataSource } from './fetch-list-data-source.js';
import { ListDataSourcePlaceholder } from './list-data-source.js';
...
describe('FetchListDataSource', () => {
  ...
  it('should provide typed filter options to the fetchPage callback', () => {
    const fetchPage = options => {
      expectTypeOf(options.filters).toEqualTypeOf();
      expectTypeOf(options.filters?.[0]?.by).toEqualTypeOf();
      return Promise.resolve({ items: [] });
    };
    expectTypeOf(fetchPage).toEqualTypeOf();
  });
  describe('defaults', () => {
    beforeEach(() => {
      ds = new FetchListDataSource({
...
//# sourceMappingURL=fetch-list-data-source.spec.js.map
