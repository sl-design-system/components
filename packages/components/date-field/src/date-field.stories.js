    ...
    slot: () => {
      const onClear = () => {
        ...
        if (dateField?.calendar) {
          dateField.calendar.selected = void 0;
        }
      };
      const onToday = () => {
        const dateField = document.querySelector('sl-date-field');
        if (dateField?.calendar) {
          dateField.calendar.selected = /* @__PURE__ */ new Date();
        }
      };
      return html`
...
export const All = {
  render: () => {
    const mockDate = /* @__PURE__ */ new Date('2025-06-15');
    return html`
      <style>
        section {
          display: inline-grid;
        ...
        <div class="date-field-wrapper">
          ...
          <sl-form-field label="Date">
            <sl-date-field
              ...
              min=${/* @__PURE__ */ new Date('2025-06-10').toISOString()}
              month=${/* @__PURE__ */ new Date('2025-06-01').toISOString()}></sl-date-field>
          </sl-form-field>
        </div>
      </section>
    `;
