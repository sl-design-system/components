import { type Node, type NodeType, type ResolvedPos, type Schema } from 'prosemirror-model';
...
export declare const rootListDepth: (
  pos: ResolvedPos,
  nodes: {
    [key: string]: NodeType;
  }
...
export declare const toggleList: (
  state: EditorState,
  dispatch: DispatchFn,
  view: EditorView,
  listType: string
...
export declare function liftFollowingList(
  state: EditorState,
  from: number,
  to: number,
...
export declare function isRangeOfType(
  doc: Node,
  $from: ResolvedPos,
  $to: ResolvedPos,
  nodeType: NodeType
): boolean;
export declare function getAncestorNodesBetween(
  doc: Node,
  $from: ResolvedPos,
  $to: ResolvedPos
): Node[];
...
export declare function toggleUnorderedList(
  state: EditorState,
  dispatch: DispatchFn,
  view: EditorView
): boolean;
...
export declare const splitListItemKeepMarks: (
  itemType: NodeType
