...
describe('sl-grid-filter-column', () => {
  ...
  describe('defaults', () => {
    ...
    it('should render the filter in the second header row', () => {
      const headers = Array.from(el.renderRoot.querySelectorAll('thead tr:last-of-type th > *'));
  ...
  describe('filtered', () => {
    ...
    it('should show the value in the search field', () => {
      const filter = el.renderRoot.querySelector(
...
//# sourceMappingURL=filter-column.spec.js.map
