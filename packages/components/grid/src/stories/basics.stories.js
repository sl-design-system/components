...
export const Basic = {
  render: (_, { loaded: { students } }) => {
    const dateOfBirthRenderer = ({ dateOfBirth }) => {
...
export const EllipsizeTextWithCustomContent = {
  render: () => {
    const files = [
      {
        empty: null,
...
export const KeyboardHeaderScroll = {
  render: (_, { loaded: { students } }) => html`
    <p>
...
export const ReorderColumns = {
  render: (_, { loaded: { students } }) => {
    ...
    __decorateClass([state()], GridReorderExample.prototype, 'columns', 2);
    try {
...
//# sourceMappingURL=basics.stories.js.map
