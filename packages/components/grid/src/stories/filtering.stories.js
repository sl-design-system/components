...
export const Custom = {
  render: (_, { loaded: { students } }) => {
    const dataSource = new ArrayListDataSource(students, {
      filters: [{ id: 'custom', by: student => student.school.id === 'school-1' }]
    });
    return html`
      <p>
...
//# sourceMappingURL=filtering.stories.js.map
