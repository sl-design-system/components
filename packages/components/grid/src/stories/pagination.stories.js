...
export const Manual = {
  render: (_, { loaded: { students } }) => {
    ...
    return html`
      ...
      <sl-grid .items=${students.slice(0, 10)}>
        <sl-grid-column grow="0" header="Nr." path="studentNumber"></sl-grid-column>
        <sl-grid-column
          grow="3"
          header="Student"
      ...
      <div class="pagination">
        <sl-paginator-status
          .itemLabel=${'students'}
          .totalItems=${students.length}></sl-paginator-status>
        <sl-paginator @sl-page-change=${onPageChange} .totalItems=${students.length}></sl-paginator>
        <sl-paginator-page-size
