  ...
  render: ({ selectAll }, { loaded: { students } }) => {
    return html`
      <sl-grid .items=${(students as Student[]).slice(0, 5)}>
        ...
        <sl-menu-button variant="inverted" fill="outline" aria-label="Block" slot="bulk-actions">
          <sl-icon name="far-eye-slash" slot="button"></sl-icon>
          <span slot="button"> Visibility </span>
          <sl-menu-item>Block</sl-menu-item>
          <sl-menu-item>Unblock</sl-menu-item>
        </sl-menu-button>

        <sl-menu-button variant="inverted" fill="outline" aria-label="Visibility" slot="bulk-actions">
          <sl-icon name="far-eye-slash" slot="button"></sl-icon>
          <span slot="button"> Visibility</span>
          <sl-menu-item>Hide Selection</sl-menu-item>
          <sl-menu-item>Show Selection</sl-menu-item>
        </sl-menu-button>

        <sl-button ${tooltip('I am a tooltip')} fill="outline" slot="bulk-actions" variant="inverted">
          <sl-icon name="far-right-to-line"></sl-icon>
          Nieuwe berekeningskolom aanmaken
        </sl-button>
        <sl-button fill="outline" slot="bulk-actions" variant="inverted">
          <sl-icon name="far-right-to-line"></sl-icon>
          Action 3
  ...
  render: ({ selectAll }, { loaded: { students } }) => {
    return html`
      <sl-grid .items=${(students as Student[]).slice(0, 5)}>
        ...
        <sl-tooltip id="tooltip-edit"> Collective Change </sl-tooltip>
        ...
        <sl-button id="tooltip-edit" fill="outline" slot="bulk-actions" variant="inverted" aria-label="Duplicate">
          <sl-icon name="far-copy"></sl-icon>
        </sl-button>

        <sl-menu-button variant="inverted" fill="outline" aria-label="Visibility" slot="bulk-actions">
          <sl-icon name="far-right-to-line" slot="button"></sl-icon>
          <span slot="button">Visibility</span>
          <sl-menu-item>Hide selection</sl-menu-item>
          <sl-menu-item>Show selection</sl-menu-item>
        </sl-menu-button>
        ...
        <sl-menu-button variant="inverted" fill="outline" aria-label="Block" slot="bulk-actions">
          <sl-icon name="far-right-to-line" slot="button"></sl-icon>
          <span slot="button">Block</span>
          <sl-menu-item>Block selection</sl-menu-item>
          <sl-menu-item>Unblock selection</sl-menu-item>
        </sl-menu-button>

        <sl-button fill="outline" slot="bulk-actions" variant="inverted">
          <sl-icon name="far-trash"></sl-icon>
          Create calculated calculated column
        </sl-button>
      </sl-grid>
    `;
  }
