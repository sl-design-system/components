...
export default css`
  ...
  :host(:where(:focus-visible, [current])) {
  ...
  :host(:where(:hover, [current])) {
    --_bg-opacity: var(--sl-opacity-interactive-plain-hover);
  }

  :host(:where(:focus-visible, [current]):not([selected], :hover)) {
    --_bg-opacity: var(--sl-opacity-interactive-plain-idle);
  }

  :host(:where(:hover, :focus-visible, [current]))::before {
  ...
  :host(:where(:hover, [current]):not([selected])) {
