...
describe('sl-menu', () => {
  ...
  describe('single select', () => {
    ...
    it('should toggle between selected items, but not deselect the current item when it is clicked again', () => {
      const item1 = el.querySelector('sl-menu-item:nth-of-type(1)'),
        item2 = el.querySelector('sl-menu-item:nth-of-type(2)');
      item1?.click();
  ...
  describe('keyboard navigation', () => {
    ...
    describe('escape key in submenu', () => {
      let parentMenuItem, submenu, submenuItem, onKeydown;
      beforeEach(async () => {
        onKeydown = spy();
