...
export const Alert: Story = {
  args: {
    onClick: async ({ message, title }) => MessageDialog.alert(message as string, title),
...
export const Confirm: Story = {
  args: {
    onClick: async ({ message, title }) => MessageDialog.confirm(message as string, title),
...
export const CustomButtons: Story = {
  args: {
    onClick: async ({ buttons, message, title }) => MessageDialog.show({ buttons, message, title }),
...
export const CustomMessage: Story = {
  args: {
    onClick: async ({ message, title }) =>
      MessageDialog.show({ message, title, buttons: [{ text: 'OK', variant: 'primary' }] }),
