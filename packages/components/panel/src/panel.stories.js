...
import '../register.js';
const densities = ['default', 'relaxed'];
const elevations = ['none', 'raised', 'sunken'];
const togglePlacements = ['start', 'end'];
const users = [
  {
