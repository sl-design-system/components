...
describe('sl-popover', () => {
  ...
  let popover;
  const onClick = event => {
    event.target.nextElementSibling.togglePopover();
  };
  ...
  describe('defaults', () => {
    beforeEach(async () => {
      ...
      popover = el.querySelector('sl-popover');
    });
  ...
  describe('Hiding popover', () => {
    const hideOnClick = event => {
      event.target.nextElementSibling.hidePopover();
    };
    beforeEach(async () => {
      el = await fixture(html`
        <div>
  ...
  describe('Showing popover', () => {
    const hideOnClick = event => {
      event.target.nextElementSibling.showPopover();
    };
    beforeEach(async () => {
      el = await fixture(html`
        <div>
