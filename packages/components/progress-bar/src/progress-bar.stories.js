...
export default {
  ...
  argTypes: {
    ...
    variant: {
      ...
      options: [void 0, 'success', 'warning', 'error']
    },
    slot: {
      table: {
        disable: true
    ...
    setTimeout(() => {
      ...
      setTimeout(() => {
        const interval = setInterval(() => {
          ...
          progressBar.variant = progressBar.value >= 100 ? 'success' : void 0;
