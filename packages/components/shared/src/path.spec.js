...
import { getNameByPath, getStringByPath, getValueByPath, setValueByPath } from './path.js';
describe('path utils', () => {
  ...
  describe('getStringByPath', () => {
    ...
    it('should return the string representation of the object', () => {
      expect(getStringByPath(person, '')).to.equal('[object Object]');
    });
  ...
  describe('setValueByPath', () => {
    describe('new object', () => {
      ...
      it('should set a non-zero array item', () => {
        ...
        expect(obj).to.deep.equal({ foo: { bar: [void 0, 'qux'] } });
      });
