...
describe('string utils', () => {
  ...
  describe('getCharacterPluralSuffix', () => {
    ...
    describe('Polish', () => {
      ...
      it('should return "\xF3w" for 5 (many form)', () => {
        expect(getCharacterPluralSuffix(5)).to.equal('\xF3w');
      });
      it('should return "\xF3w" for 0 (many form)', () => {
        expect(getCharacterPluralSuffix(0)).to.equal('\xF3w');
      });
      it('should return "\xF3w" for 11-14 (many form)', () => {
        expect(getCharacterPluralSuffix(11)).to.equal('\xF3w');
        expect(getCharacterPluralSuffix(12)).to.equal('\xF3w');
        expect(getCharacterPluralSuffix(13)).to.equal('\xF3w');
        expect(getCharacterPluralSuffix(14)).to.equal('\xF3w');
      });
      ...
      it('should return "\xF3w" for 25+ (many form)', () => {
        expect(getCharacterPluralSuffix(25)).to.equal('\xF3w');
        expect(getCharacterPluralSuffix(100)).to.equal('\xF3w');
      });
    });
    describe('Spanish', () => {
      beforeEach(() => {
      ...
      it('should return "car\xE1cter" for 1', () => {
        expect(getCharacterPluralSuffix(1)).to.equal('car\xE1cter');
      });
