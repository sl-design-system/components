...
describe('sl-tab-group', () => {
  ...
  describe('defaults', () => {
    ...
    it('should select a different tab when pressing the Enter key', async () => {
      ...
      const selectedTab = el.querySelector('sl-tab[selected]'),
        selectedPanel = el.querySelector('sl-tab-panel[aria-hidden="false"]');
  ...
  describe('activation', () => {
    ...
    it('should default to manual activation', () => {
      const tab = el.querySelector('sl-tab:nth-of-type(2)');
      tab?.focus();
