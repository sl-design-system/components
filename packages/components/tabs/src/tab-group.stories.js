...
export const Selected = {
  args: {
    ...
    tabPanels: () => {
      const onNext = event => {
        const tabGroup = event.target.closest('sl-tab-group'),
          panel = event.target.closest('sl-tab-panel'),
...
//# sourceMappingURL=tab-group.stories.js.map
