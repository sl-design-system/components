...
export default css`
  ...
  :host([size='lg']) .valid,
  :host([size='lg']) slot[name='suffix']::slotted(:not(sl-field-button)) {
  ...
  :host([disabled]) slot[name='input']::slotted(input)::placeholder {
    color: var(--sl-color-foreground-disabled);
  }
  ...
  slot[name='input']::slotted(input):focus {
    outline: none;
  }
...
`;
//# sourceMappingURL=text-field.scss.js.map
