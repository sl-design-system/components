...
describe('sl-text-field', () => {
  ...
  describe('form integration', () => {
    ...
    it('should call requestSubmit after pressing Enter in the text-field', async () => {
      const form = el2.renderRoot.querySelector('sl-form');
      spy(form, 'requestSubmit');
      el2.renderRoot.querySelector('input')?.focus();
    ...
    it('should not call requestSubmit after pressing Enter if readonly', async () => {
      const form = el2.renderRoot.querySelector('sl-form');
      spy(form, 'requestSubmit');
      el2.renderRoot.querySelector('sl-text-field')?.setAttribute('readonly', '');
      el2.renderRoot.querySelector('input')?.focus();
      await userEvent.keyboard('{Enter}');
