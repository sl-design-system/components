...
export default css`
  ...
  :host(:state(has-value)) .parts {
    color: var(--sl-color-foreground-plain);
  }

  :host(:state(placeholder-shown)) .parts {
    opacity: 0;
  }

  :host(:not(:state(placeholder-shown))) .placeholder {
    opacity: 0;
  }

  :host(:state(has-focus)) {
    outline-color: var(--sl-color-border-focused);
  }

  :host(:state(has-focus)) .parts {
    opacity: 1;
  }

  :host(:state(has-focus)) .placeholder {
    opacity: 0;
  }
  ...
  :host([readonly]) span[contenteditable] {
    cursor: default;
  }
  ...
  dialog {
    ...
    block-size: calc(8 * (1lh + var(--sl-size-200)) + 7 * var(--sl-size-050) + var(--sl-size-200));
  ...
  ul {
    max-block-size: calc(
      8 * (1lh + var(--sl-size-200)) + 7 * var(--sl-size-050) + var(--sl-size-200)
    );
  }
...
`;
//# sourceMappingURL=time-field.scss.js.map
