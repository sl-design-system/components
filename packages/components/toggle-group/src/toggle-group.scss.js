...
export default css`
  ...
  :host([disabled]) ::slotted(sl-toggle-button:state(pressed)) {
  ...
  ::slotted(sl-toggle-button) {
    ...
    --_focus-outline-offset: calc(
      var(--sl-size-outlineOffset-default) + var(--sl-size-borderWidth-button-outline)
    );

    position: relative;
  }

  ::slotted(sl-toggle-button)::after {
  ...
  :host(:not([fill='outline'])) ::slotted(sl-toggle-button) {
    --_group-compensation-start: -0.5px;
    --_group-compensation-end: -0.5px;
  }

  :host(:not([fill='outline'])) ::slotted(sl-toggle-button:first-of-type) {
    --_group-compensation-start: var(--_pill-compensation);
    --_group-compensation-end: -0.5px;
  }

  :host(:not([fill='outline'])) ::slotted(sl-toggle-button:last-of-type) {
    --_group-compensation-start: -0.5px;
    --_group-compensation-end: var(--_pill-compensation);
  }

  ::slotted(sl-toggle-button:first-of-type) {
    --_button-border-radius: calc(var(--_border-radius) - var(--sl-size-borderWidth-action)) 0 0
      calc(var(--_border-radius) - var(--sl-size-borderWidth-action));
    --_group-compensation-start: var(--_pill-compensation);
  }

  ::slotted(sl-toggle-button:last-of-type) {
    --_button-border-radius: 0 calc(var(--_border-radius) - var(--sl-size-borderWidth-action))
      calc(var(--_border-radius) - var(--sl-size-borderWidth-action)) 0;
    --_group-compensation-end: var(--_pill-compensation);
  }

  ::slotted(sl-toggle-button:last-of-type)::after {
    display: none;
  }
`;
//# sourceMappingURL=toggle-group.scss.js.map
