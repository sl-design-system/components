...
export const InvertedContained = {
  args: {
    contained: true,
    description: html`
...
export const ClickEvents = {
  args: {
    ...
    items: () => {
      ...
      return html`
        <sl-button @click=${e => handleClick(e, 'Button 1')} fill="outline">Button 1</sl-button>
        <sl-button @click=${e => handleClick(e, 'Button 2')} fill="outline">
          <sl-icon name="far-gear"></sl-icon>
          Button 2
        </sl-button>
        <sl-tool-bar-divider></sl-tool-bar-divider>
        <sl-button @click=${e => handleClick(e, 'Button 3')} fill="outline">
          <sl-icon name="far-pen"></sl-icon>
          Button 3
        </sl-button>
        <sl-menu-button fill="outline">
          <div slot="button">Menu</div>
          <sl-menu-item @click=${e => handleClick(e, 'Menu Item 1')}>
            <sl-icon name="far-pen"></sl-icon>
            Item 1
          </sl-menu-item>
          <sl-menu-item @click=${e => handleClick(e, 'Menu Item 2')}>
            <sl-icon name="far-trash"></sl-icon>
            Item 2
          </sl-menu-item>
        </sl-menu-button>
...
export const MixedVariantsAndFills = {
  render: () => {
...
//# sourceMappingURL=tool-bar.stories.js.map
