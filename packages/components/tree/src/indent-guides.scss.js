...
export default css`
  ...
  :host([last-node-in-level]) .guide.last:not(.first)::before {
    block-size: 100%;
  ...
  .guide {
    ...
    margin-inline: calc(var(--sl-size-200) - var(--sl-size-borderWidth-default)) var(--sl-size-075);
  }
  ...
  .selected {
    ...
    inset: 0 calc(var(--sl-size-010) + var(--sl-size-025)) 0 auto;
    position: absolute;
  }
  ...
  .selected::before {
    ...
    content: '';
    inset: 50% var(--sl-size-010) auto;
    margin-block-start: calc(var(--sl-size-150) / -1);
    position: absolute;
    z-index: 1;
  }
`;
//# sourceMappingURL=indent-guides.scss.js.map
