...
export const templates = {
  ...
  'sl.textArea.charCountRemaining_few': str`${0} tekenen resterend`,
  'sl.textArea.charCountRemaining_one': str`${0} teken resterend`,
  'sl.textArea.charCountRemaining_other': str`${0} tekenen resterend`,
  'sl.textArea.charCountTooMany_few': str`${0} tekenen te veel`,
  'sl.textArea.charCountTooMany_one': str`${0} teken te veel`,
  'sl.textArea.charCountTooMany_other': str`${0} tekenen te veel`,
  'sl.textArea.validation.tooLong_few': str`Verwijder minstens ${0} tekenen.`,
  'sl.textArea.validation.tooLong_one': str`Verwijder minstens ${0} teken.`,
  'sl.textArea.validation.tooLong_other': str`Verwijder minstens ${0} tekenen.`,
