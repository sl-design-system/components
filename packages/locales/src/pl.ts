...
'sl.combobox.toggleOptions': str`${0} opcje`,
...
'sl.common.validation.tooShort': str`Wprowadź co najmniej ${0} znaków (obecnie masz ${1} znak${2}).`,
...
'sl.paginator.totalPages': str`z ${0} stron`,
