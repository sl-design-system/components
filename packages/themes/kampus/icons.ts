export const icons = {
  adaptive: {
    svg: '<svg fill="var(--sl-icon-fill-default)" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16"><g><path fill-rule="evenodd" d="M15 2.998a2 2 0 0 1-3.927.533h-.407a1.47 1.47 0 0 0-1.258.712L7.574 7.301a2.53 2.53 0 0 1-.874.872.533.533 0 0 1-.77.502l-.014-.006a1.3 1.3 0 0 0-.569-.138h-.419a2 2 0 1 1 0-1.066h.474a1.47 1.47 0 0 0 1.257-.712l1.835-3.058a2.53 2.53 0 0 1 2.172-1.23h.406a2.001 2.001 0 0 1 3.929.533m-1.066 0a.933.933 0 1 1-1.866 0 .933.933 0 0 1 1.866 0M3 8.93a.933.933 0 1 0 0-1.867.933.933 0 0 0 0 1.867M13 9.998a2 2 0 1 0-1.928-2.533h-.005a.533.533 0 0 0 0 1.066h.005a2 2 0 0 0 1.929 1.467m0-1.067a.933.933 0 1 0 0-1.866.933.933 0 0 0 0 1.866" clip-rule="evenodd"/><path d="M8.324 9.923a.533.533 0 1 1-.914.55l-.4-.667a.534.534 0 0 1 .914-.55zM9.475 12.922a.534.534 0 0 0 .183-.732l-.4-.667a.534.534 0 0 0-.915.55l.4.666a.533.533 0 0 0 .732.183M8.734 7.465a.533.533 0 1 0 0 1.066h.4a.533.533 0 0 0 0-1.066z"/><path fill-rule="evenodd" d="M14.507 14.315a2 2 0 1 0-3.434-1.85h-.006a.533.533 0 1 0 0 1.066h.005a2 2 0 0 0 3.435.784m-.847-.657a.933.933 0 1 0-1.32-1.32.933.933 0 0 0 1.32 1.32" clip-rule="evenodd"/></g></svg>'
  },
  'additional-materials': {
    svg: '<svg fill="var(--sl-icon-fill-default)" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16"><g><path d="M2.322 1.003a.793.793 0 0 0-.822.794v3.334a.533.533 0 1 0 1.067 0V2.087c1.517.133 2.778.811 3.689 1.494a9.2 9.2 0 0 1 1.377 1.274v.276a.533.533 0 1 0 1.067 0v-.276q.094-.111.265-.29a9 9 0 0 1 1.112-.984c.911-.683 2.172-1.361 3.69-1.494v9.025a9.1 9.1 0 0 0-4.138 1.25.533.533 0 0 0 .542.918 8.04 8.04 0 0 1 3.878-1.112.807.807 0 0 0 .784-.804V1.797a.79.79 0 0 0-.822-.794c-1.934.078-3.504.922-4.574 1.724q-.682.511-1.27 1.129a10 10 0 0 0-1.271-1.129c-1.07-.803-2.64-1.646-4.574-1.724"/><path d="M3.433 8.264a.533.533 0 1 0 0 1.067h3a.533.533 0 1 0 0-1.067zM2.9 10.597a.534.534 0 0 1 .533-.533h3a.533.533 0 0 1 0 1.067h-3a.533.533 0 0 1-.533-.534m.533 1.267a.533.533 0 0 0 0 1.067H5.3a.533.533 0 0 0 0-1.067z"/><path fill-rule="evenodd" d="M1.833 6.33a.667.667 0 0 0-.666.667v7.334a.667.667 0 0 0 .666.666h6.2a.667.667 0 0 0 .667-.666V6.997a.667.667 0 0 0-.667-.666zm.4 1.067v6.534h5.4V7.397z" clip-rule="evenodd"/></g></svg>'
  },
  'angle-down': {
    value: 'angle-down',
    type: 'Icons',
  ...
  circle: {
    svg: '<svg fill="var(--sl-icon-fill-default)" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16"><circle cx="8" cy="8" r="8"/></svg>'
  },
  'circle-check-solid': {
    value: 'circle-check',
    type: 'Icons',
  ...
  eye: {
    svg: '<svg fill="var(--sl-icon-fill-default)" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16"><path d="M4.455 8a3.565 3.565 0 0 1 3.559-3.559c1.946 0 3.559 1.613 3.559 3.559a3.565 3.565 0 0 1-3.56 3.559A3.55 3.55 0 0 1 4.456 8m3.559 2.224A2.213 2.213 0 0 0 10.238 8c0-1.223-1-2.224-2.224-2.224H7.93c.055.167.083.306.083.445 0 1-.806 1.779-1.78 1.779-.166 0-.305 0-.444-.056V8c0 1.251.973 2.224 2.224 2.224m-5.366-6.2c1.307-1.223 3.114-2.252 5.366-2.252 2.224 0 4.031 1.029 5.338 2.252 1.307 1.196 2.168 2.642 2.585 3.642a1 1 0 0 1 0 .695c-.417.973-1.278 2.42-2.585 3.643s-3.114 2.224-5.338 2.224c-2.252 0-4.06-1.001-5.366-2.224S.48 9.334.063 8.36a1 1 0 0 1 0-.695c.417-1 1.278-2.446 2.585-3.642m5.366-.917c-1.835 0-3.309.834-4.448 1.89A9.9 9.9 0 0 0 1.369 8c.39.834 1.112 2.03 2.197 3.03 1.14 1.057 2.613 1.863 4.448 1.863 1.807 0 3.28-.806 4.42-1.863 1.085-1 1.808-2.196 2.197-3.03a9.9 9.9 0 0 0-2.197-3.003c-1.14-1.056-2.613-1.89-4.42-1.89"/></svg>'
  },
  'face-smile': {
    value: 'face-smile',
    type: 'Icons',
  ...
  'share-copy': {
    svg: '<svg fill="var(--sl-icon-fill-default)" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16"><g><path d="M10.2 1.733a.533.533 0 0 1 .533-.533H14.2a.6.6 0 0 1 .6.6v3.467a.533.533 0 0 1-1.067 0V3.02L9.311 7.444a.534.534 0 0 1-.755-.755l4.424-4.422h-2.247a.533.533 0 0 1-.533-.534M4.867 2.8a1 1 0 0 0-1 1v.467a.533.533 0 1 0 1.066 0v-.4h.4a.533.533 0 0 0 0-1.067zm-2.2 3.733h-.4v7.2h7.2v-.4a.533.533 0 1 1 1.066 0v.467a1 1 0 0 1-1 1H2.2a1 1 0 0 1-1-1V6.467a1 1 0 0 1 1-1h.467a.533.533 0 1 1 0 1.066m10.533 4.6a1 1 0 0 1-1 1h-.467a.533.533 0 0 1 0-1.066h.4v-.4a.533.533 0 1 1 1.067 0z"/><path d="M3.867 11.133a1 1 0 0 0 1 1h.466a.533.533 0 1 0 0-1.066h-.4v-.4a.533.533 0 1 0-1.066 0zM4.4 6a.533.533 0 0 1 .533.533V8.4a.533.533 0 0 1-1.066 0V6.533A.533.533 0 0 1 4.4 6m3.2 5.067a.533.533 0 0 0 0 1.066h1.867a.533.533 0 1 0 0-1.066zm-.533-7.734A.533.533 0 0 1 7.6 2.8h1.267a.533.533 0 1 1 0 1.067H7.6a.533.533 0 0 1-.533-.534m6.133 3.8a.533.533 0 0 0-1.067 0V8.4a.533.533 0 1 0 1.067 0z"/></g></svg>'
  },
  'show-all-answers': {
