...
- [#3661](https://github.com/sl-design-system/components/pull/3661) [`fb75897`](https://github.com/sl-design-system/components/commit/fb758975c074fd008bd275f95348e525970bb957) - Added new font for headings and titles in the new typography setup called The Message. Include the new `fonts.css` file for the type-face declarations.
  This is new font is not yet used in components, but is already available in the new [Typography setup](https://storybook.sanomalearning.design?path=/story/utilities-typography--typography-styles&globals=theme:magister)
...
- [#3499](https://github.com/sl-design-system/components/pull/3499) [`8e583d9`](https://github.com/sl-design-system/components/commit/8e583d9894ad680f4a7141a9c9b03bd999993d3b) - Changed background in solid secondary button in dark mode to improve contrast.
...
- [#3091](https://github.com/sl-design-system/components/pull/3091) [`ddf0175`](https://github.com/sl-design-system/components/commit/ddf0175ec6f60add915c485e45c77511cf4c4664) - Change `color-background-grey-subtle` from `rgba({magister.color.palette.grey.200}, {magister.opacity.subtle})` to `rgba({magister.color.palette.grey.600}, {magister.opacity.subtle})`, `color-background-grey-subtlest` from `rgba({magister.color.palette.grey.400}, {magister.opacity.subtlest})` to `rgba({magister.color.palette.grey.600}, {magister.opacity.subtlest})`, `color-background-neutral-bold` from `{magister.color.palette.grey.050}` to `{magister.color.palette.grey.200}` and `color-foreground-neutral-onBold` from `{magister.color.foreground.accent.grey.onBold}` to `{magister.color.foreground.bold}`.
...
- [#2734](https://github.com/sl-design-system/components/pull/2734) [`f676dd5`](https://github.com/sl-design-system/components/commit/f676dd52c83ef2f3429d9a393b5ec634fc05bf0e) - Inverted onBold colour changed to blue
...
- [#1927](https://github.com/sl-design-system/components/pull/1927) [`0b2d135`](https://github.com/sl-design-system/components/commit/0b2d135db336f993e7961e3ec5e532a3deb078f0) - Changes header font from Arboria to Open Sans
...
- [#1772](https://github.com/sl-design-system/components/pull/1772) [`f27bb8a`](https://github.com/sl-design-system/components/commit/f27bb8a1e588b2e9b40fa49cd97e5188a7fbbf17) - Fixed wrong text colour in switch component
...
- [#1409](https://github.com/sl-design-system/components/pull/1409) [`cddffd6`](https://github.com/sl-design-system/components/commit/cddffd6ac0a4b021b72e32a7c11efd3d078b9d45) - Fix the line-height for the tooltip
...
- [#1379](https://github.com/sl-design-system/components/pull/1379) [`4242ea2`](https://github.com/sl-design-system/components/commit/4242ea24a85d758a71bb8c88aa6ae8a0aba442b5) - Remove breaking extra whitespace in certain color tokens
