...
export const icons = {
  ...
  'versterk-jezelf': {
    svg: '<svg fill="var(--sl-icon-fill-default)" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16"><g clip-path="url(#a)"><path d="M12.933 16c-.363 0-.738-.252-.75-.738V11.29c0-.217.095-.422.257-.565a5.23 5.23 0 0 0 1.81-3.947c-.05-2.935-2.477-5.323-5.415-5.323h-.237c-2.938 0-5.368 2.39-5.415 5.328v.777c-.005.075 0 .147 0 .22.005.175.01.355-.073.535-.3.645-.83 1.662-1.295 2.488h.58l.055-.003c.2 0 .398.092.543.252.142.158.212.36.19.556 0 .05 0 .204-.025.412 0 .158-.008.322-.013.488-.007.185-.015.37-.012.55q-.012.519.09 1.02a.55.55 0 0 0 .495.307q.034.001.067-.005c.703-.07 2.613-.383 5.378-.88.585-.14.617-.937.582-1.4a.746.746 0 0 1 .758-.765c.29 0 .657.17.735.647.11 1.57-.55 2.686-1.763 2.986-3.145.555-4.852.827-5.537.887a2.067 2.067 0 0 1-2.145-1.343 5.7 5.7 0 0 1-.153-1.447v-.758h-.027a1.65 1.65 0 0 1-1.058-.502 1.44 1.44 0 0 1-.052-1.72c.327-.58.682-1.28.995-1.898l.177-.347c-.002-.09 0-.577 0-.577-.12-1.795.538-3.555 1.845-4.953C4.888.84 6.775 0 8.703 0c3.817 0 6.98 3.045 7.055 6.783a6.76 6.76 0 0 1-2.078 4.847l.005 3.625a.736.736 0 0 1-.75.742zM8.65 9.088c-.342 0-.735-.223-.785-.713V7.26h-1.13c-.307 0-.545-.13-.68-.365a.87.87 0 0 1 0-.842c.138-.236.375-.368.673-.368h1.137V4.59a.78.78 0 0 1 .205-.592.8.8 0 0 1 .583-.236c.225 0 .44.088.585.238.142.15.212.357.202.598v1.085h1.095c.508.057.735.434.738.782a.78.78 0 0 1-.716.79H9.443V8.35a.78.78 0 0 1-.788.732z"/></g><defs><clipPath id="a"><path d="M0 0h16v16H0z"/></clipPath></defs></svg>'
  },
  xmark: {
    value: 'xmark',
    type: 'icons',
