            ...
            - generic [ref=e39]:
                ...
                - generic [ref=e160]:
                    ...
                    - list [ref=e166]:
                        ...
                        - listitem [ref=e171]:
                            - link "CSS Anchor Positioning" [ref=e172] [cursor=pointer]:
                                - /url: https://developer.mozilla.org/en-US/docs/Web/CSS/CSS_anchor_positioning
                    - paragraph [ref=e173]: 'To use these polyfills, you need to install the following packages:'
                    - list [ref=e174]:
                        - listitem [ref=e175]:
                            - code [ref=e176]: '@webcomponents/scoped-custom-element-registry'
                        - listitem [ref=e177]:
                            - code [ref=e178]: invokers-polyfill
                            - text: (version >= 1.0.2, earlier versions do not work properly with custom elements)
                        - listitem [ref=e179]:
                            - code [ref=e180]: '@oddbird/css-anchor-positioning'
                    - paragraph [ref=e181]: 'Once installed you need to import the polyfills in your application. You can do this by importing the polyfills in your main JS file:'
                    - code [ref=e183]: import '@webcomponents/scoped-custom-element-registry/scoped-custom-element-registry.min.js'; import 'invokers-polyfill';
                    - paragraph [ref=e184]: 'Another option is to include them in your HTML:'
                    - code [ref=e186]:
                        - generic [ref=e187]:
                            - generic [ref=e188]: <script
                            - text: src
                            - generic [ref=e189]: ="./node_modules/@webcomponents/scoped-custom-element-registry/scoped-custom-element-registry.min.js"
                            - text: '>'
                        - generic [ref=e190]:
                            - generic [ref=e191]: </script
                            - text: '>'
                        - generic [ref=e192]:
                            - generic [ref=e193]: <script
                            - text: src
                            - generic [ref=e194]: ="./node_modules/invokers-polyfill/invokers-polyfill.min.js"
                            - text: '>'
                        - generic [ref=e195]:
                            - generic [ref=e196]: </script
                            - text: '>'
                    - heading "CSS Anchor Positioning" [level=3] [ref=e197]:
                        - link "CSS Anchor Positioning" [ref=e198] [cursor=pointer]:
                            - /url: '#css-anchor-positioning'
                    - paragraph [ref=e199]:
                        - text: Components such as the tooltip position themselves using
                        - link "CSS Anchor Positioning" [ref=e200] [cursor=pointer]:
                            - /url: https://developer.mozilla.org/en-US/docs/Web/CSS/CSS_anchor_positioning
                        - text: . Browsers without support for it need the
                        - link "CSS Anchor Positioning polyfill" [ref=e201] [cursor=pointer]:
                            - /url: https://anchor-positioning.oddbird.net/
                        - text: ', otherwise those components end up in the wrong place on the screen.'
                    - paragraph [ref=e202]:
                        - text: This polyfill needs a little more setup than the other two. Our components style their shadow DOM with constructed stylesheets, which the polyfill only picks up after
                        - code [ref=e203]: patchAndPolyfillConstructedStylesheets()
                        - text: has patched
                        - code [ref=e204]: CSSStyleSheet
                        - text: and
                        - code [ref=e205]: ShadowRoot
                        - text: . So instead of importing the package directly, import its
                        - code [ref=e206]: /fn
                        - text: 'entrypoint and apply it yourself:'
                    - code [ref=e208]: "if (!('anchorName' in document.documentElement.style)) { window.ANCHOR_POSITIONING_POLYFILL_OPTIONS = { positionAreaContainingBlock: false }; const { default: polyfill, patchAndPolyfillConstructedStylesheets } = await import( '@oddbird/css-anchor-positioning/fn' ); patchAndPolyfillConstructedStylesheets(); await polyfill(); }"
                    - paragraph [ref=e209]: 'A couple of notes about this snippet:'
                    - list [ref=e210]:
                        - listitem [ref=e211]:
                            - text: The
                            - code [ref=e212]: anchorName
                            - text: check makes sure the polyfill is only downloaded and applied in browsers that need it.
                        - listitem [ref=e213]:
                            - code [ref=e214]: patchAndPolyfillConstructedStylesheets()
                            - text: has to run before the first component is upgraded, so run this before importing any
                            - code [ref=e215]: register.js
                            - text: . The
                            - code [ref=e216]: polyfill()
                            - text: call after it takes care of anchor positioning in the light DOM.
                        - listitem [ref=e217]:
                            - code [ref=e218]: 'positionAreaContainingBlock: false'
                            - text: tells the polyfill not to wrap positioned elements in an extra element. That wrapper breaks CSS that relies on the DOM structure of our components. This is the same configuration we use in our own Storybook.
                    - heading "No longer needed" [level=3] [ref=e219]:
                        - link "No longer needed" [ref=e220] [cursor=pointer]:
                            - /url: '#no-longer-needed'
                    - paragraph [ref=e221]: 'The following polyfills were previously required but are no longer needed since all major browsers now support these features:'
                    - list [ref=e222]:
                        - listitem [ref=e223]:
                            - link "Element Internals" [ref=e224] [cursor=pointer]:
                                - /url: https://caniuse.com/mdn-api_elementinternals
                - generic [ref=e225]:
                    - heading "Start using components" [level=2] [ref=e226]:
                        - link "Start using components" [ref=e227] [cursor=pointer]:
                            - /url: '#start-using-components'
                    - paragraph [ref=e228]: 'To start using the button in our example, you need to import the button component in your application. You can do this by importing the button component in your main JS file:'
                    - code [ref=e230]: import '@sl-design-system/button/register.js';
                    - paragraph [ref=e231]:
                        - text: This will load the button component and register it as
                        - code [ref=e232]: <sl-button>
                        - text: '. After that you can start using the button in your application:'
                    - code [ref=e234]:
                        - generic [ref=e235]:
                            - generic [ref=e236]: <sl-button
                            - text: '>'
                        - text: Hello world!
                        - generic [ref=e237]:
                            - generic [ref=e238]: </sl-button
                            - text: '>'
                    - paragraph [ref=e239]:
                        - text: If you encounter errors compiling because Angular doesn't recognize the SLDS components as valid tags you can add
                        - code [ref=e240]: CUSTOM_ELEMENTS_SCHEMA
                ...
                - generic [ref=e249]:
                    ...
                    - paragraph [ref=e269]:
                        ...
                        - code [ref=e270]: '@mixin sl-theme-base'
                        - text: ','
                        - code [ref=e271]: '@mixin sl-theme-light'
                        - text: and
                        - code [ref=e272]: '@mixin sl-theme-dark'
                    ...
                    - heading "How do I setup my Bitbucket pipeline to work with the SLDS packages?" [level=3] [ref=e274]:
                        - link "How do I setup my Bitbucket pipeline to work with the SLDS packages?" [ref=e275] [cursor=pointer]:
                    ...
                    - code [ref=e279]: '//npm.pkg.github.com/:_authToken=${SLDESIGNSYSTEMS_GITHUB_NPM_AUTH_TOKEN}'
                    - heading "Which browsers are supported?" [level=3] [ref=e280]:
                        - link "Which browsers are supported?" [ref=e281] [cursor=pointer]:
                            - /url: '#which-browsers-are-supported'
                    - paragraph [ref=e282]: We support the 2 latest versions of the major browsers Chrome, Edge, Firefox and Safari. For example if the latest version is Chrome 100, we support Chrome 100 and 99.
                    - heading "Which versions of Angular are supported?" [level=3] [ref=e283]:
                        - link "Which versions of Angular are supported?" [ref=e284] [cursor=pointer]:
                    ...
                    - paragraph [ref=e285]:
                        ...
                        - link "the documentation on Angular.io" [ref=e286] [cursor=pointer]:
                            - /url: https://angular.io/guide/releases#actively-supported-versions
                        - text: .
                    - heading "Do you support SSR?" [level=3] [ref=e287]:
                        - link "Do you support SSR?" [ref=e288] [cursor=pointer]:
                            - /url: '#do-you-support-ssr'
                    - paragraph [ref=e289]: Server-side rendered web components is a hard problem and the web standards related to this continue to evolve. At the moment we do not support this, but we may look at this again in the future.
            - navigation "Contents" [ref=e293]:
                - text: CONTENTS
                - link "Steps" [ref=e294] [cursor=pointer]:
                    - /url: '#steps'
                - link "Make sure you have access" [ref=e295] [cursor=pointer]:
                    - /url: '#make-sure-you-have-access'
                - link "Installing the SL Design System package(s)" [ref=e296] [cursor=pointer]:
                    - /url: '#installing-the-sl-design-system-package(s)'
                - link "Setup a theme" [ref=e297] [cursor=pointer]:
                    - /url: '#setup-a-theme'
                - link "Add polyfills" [ref=e298] [cursor=pointer]:
                    - /url: '#add-polyfills'
                - link "Start using components" [ref=e299] [cursor=pointer]:
                    - /url: '#start-using-components'
                - link "Example project" [ref=e300] [cursor=pointer]:
                    - /url: '#example-project'
                - link "Troubleshooting and FAQ" [ref=e301] [cursor=pointer]:
                    - /url: '#troubleshooting-and-faq'
```
...
```ts
  ...
  77 |         const response = await page.goto(url, { waitUntil: 'load' });
  78 |
  79 |         expect(response, `Route not reachable: ${url}`).not.toBeNull();
  80 |         expect(response?.ok(), `Route returned an error for ${url}`).toBeTruthy();
  81 |
  82 |         results = await axe
  83 |           .include('main')
  84 |           .exclude('sl-tab-group.ds-tab-group > sl-tab')
  85 |           .analyze();
  86 |
> 87 |         expect(results.violations.length, 'Accessibility violations found, see details above').toBe(0);
     |                                                                                                ^ Error: Accessibility violations found, see details above
  88 |       });
  89 |     });
  90 | });
