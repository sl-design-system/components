...
The `exports` and `publishConfig.exports` fields are **generated by tsdown** during the build; copy them from the component you mirror and never hand-tune them afterwards. In development `exports` points at the TypeScript sources (`"." : "./src/index.ts"`), while `publishConfig.exports` points at the built `dist` output:

```json
"exports": {
  ".": "./src/index.ts",
  "./register.js": "./src/register.ts",
