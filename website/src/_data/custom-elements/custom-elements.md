...
| `reportValidity` |         | Method that checks the validity of a form element and reports validation constraints or errors associated with it. The method works similar to checkValidity() function. |                                          | `boolean` | FormControlMixin |
| `setFormValue`   |         | Method used to set the value of the form element.                                                                                                                        | `` value: FormControlValue, : `value` `` | `void`    | FormControlMixin |
...
| `reportValidity` |         | Method that checks the validity of a form element and reports validation constraints or errors associated with it. The method works similar to checkValidity() function. |                                          | `boolean` |                |
| `setFormValue`   |         | Method used to set the value of the form element.                                                                                                                        | `` value: FormControlValue, : `value` `` | `void`    |                |
