...
|3|Option Items | Menu options divided into Option Button (regular button behavior), Selection Option (checkbox or radio behavior), and Sub-Menu Button (opens a nested menu).|no|
