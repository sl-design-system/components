...
|-|-|-|-|
|`role`	|`'radiogroup'`|Makes it clear that our custom component is a radio group |no [Note 1]|
...
### Radio Button  WAI-ARIA Roles, States, and Properties
|Attribute | Value | Description | User supplied |
|-|-|-|-|
|`role`	|`'radio'`|Makes it clear that our custom component is a radio group |no [Note 1]|
|`aria-labelledby`|string| When different element serves as the label this property can be set to the `id` of that element|yes|
