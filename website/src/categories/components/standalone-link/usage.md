...
## When not to use
Do not use a Link Button when the primary purpose is to perform an action rather than navigate. Link Buttons are intended for navigation to another page, view, or resource. If the interaction init[...]
